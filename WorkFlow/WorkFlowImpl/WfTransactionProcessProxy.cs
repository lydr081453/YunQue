...
{
   public class WfTransactionProcessProxy:MySubject,IWFProcess
    {
    private IWFProcess m_process;
    private WFProcessMgrImpl processMgr;
    private Hashtable context;

    public WfTransactionProcessProxy(WFProcessMgrImpl processMgr,IWFProcess process,Hashtable context) {
