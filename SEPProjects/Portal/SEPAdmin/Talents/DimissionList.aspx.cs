...
{
    public partial class DimissionList : ESP.Web.UI.PageBase
    {


        protected void Page_Load(object sender, EventArgs e)
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(SEPAdmin.Talents.DimissionList));
        ...
        private void BindData()
        {
            ...
            string orderby = " order by lastday desc ";
        ...
        protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblJoinDate.Text = model.joinDate<= new DateTime(1900, 1, 1) ? "" : model.joinDate.ToString("yyyy-MM-dd");
                ...
                //    lnkEdit.NavigateUrl = "TalentEdit.aspx?bakurl=DimissionList.aspx&userid=" + model.UserID;
                //else
                //    lnkEdit.NavigateUrl = "TalentNew.aspx?talentid=" + model.UserID;
            }
        }
