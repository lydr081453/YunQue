<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    EnableEventValidation="false" CodeBehind="InternalList.aspx.cs" Inherits="SEPAdmin.Talents.InternalList" %>
   ...
   <script type="text/javascript" src="/public/js/DatePicker.js"></script>
    ...
    <script type="text/javascript">
        ...
        $().ready(function() {
            ...
            SEPAdmin.Talents.InternalList.getalist($("#<%=hidtype.ClientID %>").val(), init1);
            function init1(r) {
                if (r.value != null)
            ...
            SEPAdmin.Talents.InternalList.getalist($("#<%=hidtype1.ClientID %>").val(), init2);
            function init2(r) {
                $("#<%=ddltype2.ClientID %>").empty();
                if (r.value != null)
            ...
            $("#<%=ddltype.ClientID %>").change(function() {
                ...
                SEPAdmin.Talents.InternalList.getalist($("#<%=ddltype.ClientID %>").val(), pop1);
                function pop1(r) {
                    if (r.value != null)
            ...
            $("#<%=ddltype1.ClientID %>").change(function() {
                ...
                SEPAdmin.Talents.InternalList.getalist($("#<%=ddltype1.ClientID %>").val(), pop2);
                function pop2(r) {
                    if (r.value != null)
                        for (i = 0; i < r.value.length; i++) {
                ...
                <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvList_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="简历" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href="TalentEdit.aspx?bakurl=InternalList.aspx&userid=<%# Eval("UserID").ToString() %>">
