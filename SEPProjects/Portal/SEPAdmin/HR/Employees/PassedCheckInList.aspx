<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Employees_PassedCheckInList" Codebehind="PassedCheckInList.aspx.cs" %>
    ...
    <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
        ...
        <Columns>
            <asp:TemplateField HeaderText="姓名">
                <ItemTemplate>
                    <a href='PassedCheckInDetail.aspx?passedInfoId=<%#Eval("id") %>'><%# Eval("sysusername") %></a>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <%--<asp:TemplateField HeaderText="编辑" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a href='PassedCheckInEdit.aspx?passedInfoId=<%#Eval("id") %>'>
