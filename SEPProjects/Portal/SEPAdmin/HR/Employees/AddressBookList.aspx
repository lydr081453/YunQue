<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddressBookList.aspx.cs"
    Inherits="AddressBookList" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" %>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                ...
                                DataKeyNames="userid,status,EmployeesInPositionsList" Width="100%">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="部门" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Repeater ID="rep" runat="server">
                                                <ItemTemplate>
                                                    <%# Eval("CompanyName") == null ? "" : Eval("CompanyName").ToString() %>--
