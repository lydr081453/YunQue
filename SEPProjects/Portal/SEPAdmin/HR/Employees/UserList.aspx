<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="SEPAdmin.HR.Employees.UserList" %>
        ...
        <table>
            <asp:Repeater runat="server" ID="rptUserList">
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            <input type="radio" name="ckbUser" class="ckbUser" id='ckbUser_<%# Eval("UserID")%>' value='<%# Eval("UserID")%>' />
                        </td>
                        <td>
                            <%# Eval("Username")%>
                        </td>                        
