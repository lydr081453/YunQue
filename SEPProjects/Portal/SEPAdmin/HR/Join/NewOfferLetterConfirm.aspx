<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewOfferLetterConfirm.aspx.cs"
    Inherits="NewOfferLetterConfirm" %>
            ...
            <tr>
                <td colspan="4" style="font-size: 12pt; background-color: #f8f8f8;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="95%" style="padding: 10px 0 10px 0;">
                        ...
                        <tr>
                            <td style="font-size: 12pt; padding: 0 0 0 32px;">（二）学生证原件<font color="red">*</font>
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 12pt; padding: 0 0 0 32px;">（三）学校工作介绍信（或推荐信）<font color="red">*</font>
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 12pt; padding: 0 0 0 32px;">（四）担保书（担保人：父亲或母亲；担保人工作单位；详细家庭住址；座机及手机电话）
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 12pt; padding: 0 0 0 32px;">（五）一寸彩色相片一张及正面电子照片一张
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 12pt; padding: 0 0 0 32px;">（六）本人银行卡（工资卡）北京：招行卡原件及复印件<asp:Label ID="lblCard" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <hr style="border-top: 1px dashed #ee770f; height: 1px" />
                                        ...
                                        <td style="background-color: #ffffff;">
                                            <table border="0" cellpadding="1" cellspacing="0" width="97%" align="center" style="margin: 10px 0 10px 0; background-color: #ffffff;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding: 5px 10px 0 10px;border:1px;" rowspan="5">
                                                        <label for="file" style="width:150px; border:1px solid red;">
                                                            <div style="width: 150px; height: 150px; border: 1px dashed #fff; display: flex; justify-content: center; align-items: center;">
                                                                <%--<img class="imgAvater hide" id="imgAvater" name="imgAvater" runat="server" />--%>
                                                                <asp:Image ID="imgAvater" CssClass="imgAvater hide" name="imgAvater" runat="server" />
                                                                <div class="cross">
                                                                </div>
                                                            </div>
                                                        </label></td>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                                                            <tr>
                                                                <td colspan="2" style="font-size: 10pt; padding: 5px 10px 0 10px; font-weight: bold;">上传头像:
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2" style="padding: 5px 10px 0 10px;">
                                                                    <input type="file" id="btnImage" runat="server" style="height: 28px;" />
                                                            ...
                                                            <tr>
                                                                <td width="40%" style="padding: 5px 10px 0 10px;">
                                                                    <div id="Step2Container">
                                                                        ...
                                                                        <div style="display: none">
                                                                            ...
                                                                            <asp:TextBox ID="txt_DropWidth" runat="server" Text="500"></asp:TextBox><br />
                                                                            <asp:TextBox ID="txt_DropHeight" runat="server" Text="500"></asp:TextBox><br />
                                                                ...
                                                                <td style="padding: 5px 0 0 0;">
                                                                    ...
                                                                    <div class="uploaddiv">
                                                                        <asp:Button ID="btn_Image" runat="server" Text="保存头像" CausesValidation="false" OnClick="btn_Image_Click"
                                                                            Visible="false" />
                                                                    </div>
                                                                </td>
                                                            </tr>
