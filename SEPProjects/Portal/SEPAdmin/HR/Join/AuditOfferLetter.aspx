<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditOfferLetter.aspx.cs" Inherits="AuditOfferLetter" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="650" align="center" style="line-height:200%;">
            <tr>
                <td colspan="2" align="left">
                  <span style="font-size: 15pt; font-weight: bold;">有新的入职员工需要您审核,以下是聘用任职信</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <span style="font-size: 12pt;font-weight: bold;">4．薪酬：</span><span style="font-size: 12pt;">公司严格按照国家相关规定执行，所有报酬均须缴纳个人所得税。根据我们公司的薪资政策，员工薪酬构成包括：<br />
                        <span style="margin: 0px 0px 0px 80px">a）月基本工资（<asp:Label ID="labPreBasePay" runat="server" />%）+ 月绩效工资（<asp:Label ID="labPreMeritPay" runat="server" />%）；<br />
                        </span>
                        <span style="margin: 0px 0px 0px 80px">b）双薪即13个月工资（发放双薪当月在职员工）；<br /></span>
                        <span style="margin: 0px 0px 0px 80px">c）奖金，年底视公司效益、团队业绩和个人工作表现而决定。<br /></span>
                        <span style="margin: 0px 0px 0px 35px">据此，您每月薪资包括税前基本工资
                            <span style="font-size: 12pt;font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;"><asp:Label
                                ID="labNowBasePay" runat="server" /></span>元整，税前绩效工资<span style="font-size: 12pt;
                                    font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;"><asp:Label
                                        ID="labNowMeritPay" runat="server" /></span>元整。另外，公司将为您代扣代缴个人所得税，并严格按照国家相关规定为您缴纳社保和住房公积金。<br />
                            <br />
                        </span>
                        <span style="margin: 0px 0px 0px 35px">期待着您与公司共同发展。同时，公司将尽力为您实现个人事业目标提供一切必要的支持。<br />
                            <br />
