<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOfferLetter.aspx.cs" Inherits="SEPAdmin.HR.Join.SalesOfferLetter" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="650" align="center" style="line-height: 200%;">
                ...
                <tr>
                    <td align="left" width="50%" valign="top">
                        <span style="font-size: 12pt; font-weight: bold;">致：</span><span style="font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;">
                ...
                <tr>
                    <td colspan="2">
                        <span style="font-size: 12pt; font-weight: bold;">1．职位：</span><span style="font-size: 12pt;">您将在公司担任“<span style="font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;">
                            <asp:Label ID="labPosition" runat="server" />
                        </span>”（<span style="font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;">
...
<%--                <tr>
                    <td colspan="2">
                        <span style="font-size: 12pt; font-weight: bold;">2．试用期：</span><span style="font-size: 12pt;"> 自您加盟之日(<span style="font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;">
                ...
                <tr>
                    <td colspan="2">
                        <span style="font-size: 12pt; font-weight: bold;">2．劳动合同：</span><span style="font-size: 12pt;">入职当月即与您签订三年固定期限的劳动合同（含试用期）。</span><p />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <span style="font-size: 12pt; font-weight: bold;">3．薪酬：</span><span style="font-size: 12pt;">公司严格按照国家相关规定执行，所有报酬均须缴纳个人所得税。根据我们公司的薪资政策，员工薪酬构成包括：<br />
                            ...
                            </span><span style="margin: 0px 0px 0px 80px">b）奖金，年底视公司效益、团队业绩和个人工作表现而决定。<br />
                            </span><span style="margin: 0px 0px 0px 35px">据此，您每月薪资包括税前基本工资固定值<span style="font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;"><asp:Label ID="labNowBasePay" runat="server" /></span>元整，税前绩效工资参考值<span style="font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 0 5px 0px 5px;"><asp:Label
                                ID="labNowMeritPay" runat="server" /></span>元整。此绩效工资与团队业绩及个人绩效表现相关，具体发放数额及发放形式与所在团队的绩效考核标准一致。<br/>
                                公司将为您代扣代缴个人所得税，并严格按照国家相关规定为您缴纳社保和住房公积金。<br />
                                <br />
                ...
                <tr>
                    <td align="left" width="50%" valign="top">
                        ...
                        <p />
                        <div style="font-size: 12pt; margin: 0px 0px 0px 80px;">
                            <asp:Label ID="labDateTime" runat="server" />
                        </div>
                    </td>
