<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DimissionMail2.aspx.cs" Inherits="SEPAdmin.HR.Print.DimissionMail2" %>
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
  ...
  <tr>
    <td style="background-repeat:repeat-x; padding:0 10px 20px 10px;">各位同事，以下人员已确认离职：<br />
      <br />
