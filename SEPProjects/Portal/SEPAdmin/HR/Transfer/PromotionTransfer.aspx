<%@ Page Language="C#" AutoEventWireup="true" Inherits="Transfer_PromotionTransfer" MasterPageFile="~/MasterPage.master" Codebehind="PromotionTransfer.aspx.cs" %>
        ...
        <tr>
         ...
         <Columns>
            <asp:TemplateField HeaderText="姓名">
                <ItemTemplate>
                    <a href='PromotionTransferDetail.aspx?proid=<%#Eval("id") %>'><%# Eval("sysUserName")%></a>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <%--<asp:TemplateField HeaderText="编辑">
                ...
                <ItemTemplate>
                    <a href='PromotionTransferEdit.aspx?proid=<%#Eval("id") %>&userid=<%#Eval("sysid") %>'>
