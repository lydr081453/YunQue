...
public partial class Transfer_SalaryTransfer : ESP.Web.UI.PageBase
{
    ...
    private void ListBind()
    {
        ...
        {
            strWhere = string.Format(" and a.sysUserName like '%{0}%'", txtuserName.Text.Trim());
        }
        ...
        if (empid.Length > 0)
        {
            ...
            strWhere += (string.Format(" and a.companyID in ({0})", empid));
        }
        DataSet ds = SalaryManager.GetList(strWhere);
    ...
    protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Del")
        {
            ...
            ESP.HumanResource.Entity.SalaryInfo model = SalaryManager.GetModel(id);
            SalaryManager.Delete(model, LogManager.GetLogModel(UserInfo.Username + "删除了" + model.sysUserName + "的薪资调整登记", UserInfo.UserID, UserInfo.Username, model.sysid, model.sysUserName, Status.Log));
