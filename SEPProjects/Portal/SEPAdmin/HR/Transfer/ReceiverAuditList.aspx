<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiverAuditList.aspx.cs"
    Inherits="SEPAdmin.HR.Transfer.ReceiverAuditList" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript">
        ...
        function ReceiverAudit(obj, detailId) {
            if (confirm("您确认接收此业务单据？")) {
                obj.href = "ReceiverAuditList.aspx?detailid=" + detailId + "";
                return true;
            }
        }
    ...
    <table width="100%">
        ...
        <tr>
            <td>
                <asp:GridView ID="gvDetailList" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="确认" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a onclick="ReceiverAudit(this, '<%# Eval("Id") %>');" style="cursor: pointer;">
