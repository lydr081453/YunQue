<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferMgt.aspx.cs" Inherits="SEPAdmin.HR.Transfer.TransferMgt" MasterPageFile="~/MasterPage.master" %>
                ...
                <asp:GridView ID="gvTransfer" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvTransfer_RowDataBound" OnRowCommand="gvTransfer_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="转组" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                               <a href="TransferDone.aspx?id=<%#Eval("Id").ToString() %>"><img src="/images/audit.gif" alt="转组" /></a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
