<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DimissionAuditedList.aspx.cs" Inherits="DimissionAuditedList" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#ctl00_ContentPlaceHolder1_txtBeginTime").datepicker();
            $("#ctl00_ContentPlaceHolder1_txtEndTime").datepicker();
        });
    </script>
    ...
    <table width="100%" class="tableForm">
        ...
        <tr>
            ...
            <td class="oddrow-l">
                <asp:TextBox ID="txtBeginTime" runat="server" onkeyDown="return false; " />&nbsp --
                &nbsp<asp:TextBox ID="txtEndTime" runat="server" onkeyDown="return false; " />
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="DimissionId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="HRReason" HeaderText="离职原因" ItemStyle-Width="30%" />
                        ...
                        <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href="DimissionFormView.aspx?userid=<%# Eval("UserId") %>&backUrl=DimissionAuditedList.aspx" title="查看">
