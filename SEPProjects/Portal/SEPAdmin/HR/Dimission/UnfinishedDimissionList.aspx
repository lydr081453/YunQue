<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnfinishedDimissionList.aspx.cs" 
    Inherits="SEPAdmin.HR.Dimission.UnfinishedDimissionList" MasterPageFile="~/MasterPage.Master" %>
            ...
            <td>
                <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="DimissionId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Reason" HeaderText="离职原因" />
                        ...
                        <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href="DimissionAuditEdit.aspx?dimissionid=<%# Eval("DimissionId") %>" title="审批"><img src="../../images/edit.gif" /></a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
