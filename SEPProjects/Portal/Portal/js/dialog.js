...
function dialog(title, content, width, height, cssName) {
    dialog(title, content, width, height, cssName,false);
}

function dialog(title, content, width, height, cssName,refresh) {
    //hidselect();
    isRefresh = refresh;
    if (dialogFirst == true) {
        ...
        //temp_float += "<div class=\"title\" ><h4></h4><span onclick=\"hidselect();onPageRefresh();\">关闭</span></div>";
    ...
    switch (contentType) {
        ...
        case "id":
            ...
            break;
        case "iframe":
            $("#floatBox .content").html("<iframe src=\"" + content + "\" width=\""+width+"px\" height=\"" + (parseInt(height) - 50) + "px" + "\" scrolling=\"auto\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\"></iframe>");
