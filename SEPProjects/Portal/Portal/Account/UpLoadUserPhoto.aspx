<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpLoadUserPhoto.aspx.cs" Inherits="Portal.WebSite.Account.UpLoadUserPhoto" %>
...
<head id="Head1" runat="server">
    <title></title>
    <link href="CutImage/css/main.css"type="text/css" rel="Stylesheet"/>
    <script type="text/javascript" src="CutImage/js/jquery1.2.6.pack.js"></script>
    <script  type="text/javascript" src="CutImage/js/ui.core.packed.js" ></script>
    <script type="text/javascript" src="CutImage/js/ui.draggable.packed.js" ></script>
    <script type="text/javascript" src="CutImage/js/CutPic.js"></script>
     ...
     <div class="left">
         ...
         <div id="CurruntPicContainer">
            ...
            <div class="photocontainer">
                <asp:Image ID="imgphoto" runat="server" ImageUrl="CutImage/image/man.GIF" />
            </div>
         </div>
         <!--Step 2-->
           ...
           <div class="uploadtooltip">您可以拖动照片以裁剪满意的头像</div>                              
                   <div id="Canvas" class="uploaddiv">
                            ...
                            <div id="ImageDragContainer">                               
                               <asp:Image ID="ImageDrag" runat="server" ImageUrl="CutImage/image/blank.jpg" CssClass="imagePhoto" ToolTip=""/>                                                        
                            </div>
                            <div id="IconContainer">                               
                               <asp:Image ID="ImageIcon" runat="server" ImageUrl="CutImage/image/blank.jpg" CssClass="imagePhoto" ToolTip=""/>                                                        
                            </div>                          
                    </div>
                    <div class="uploaddiv">
                       <table>
                            <tr>
                                <td id="Min">
                                        <img alt="缩小" src="CutImage/image/_c.gif" onmouseover="this.src='CutImage/image/_c.gif';" onmouseout="this.src='CutImage/image/_h.gif';" id="moresmall" class="smallbig" />
                                </td>
                                <td>
                                    <div id="bar">
                                        <div class="child">
                                ...
                                <td id="Max">
                                        <img alt="放大" src="CutImage/image/c.gif" onmouseover="this.src='CutImage/image/c.gif';" onmouseout="this.src='CutImage/image/h.gif';" id="morebig" class="smallbig" />
                                </td>
                            </tr>
                        </table>
                    </div>
