<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OffTuneEdit.ascx.cs"
    Inherits="AdministrativeWeb.UserControls.Matter.OffTuneEdit" %>
...
<script language="javascript" type="text/javascript">
    ...
    function SubmitCheckOffTune() {
        ...
        var offTuneCause = document.getElementById("<%=txtOffTuneCause.ClientID %>");
                                        ...
                                        <tr>
                                            <td>
                                                <span id="dvAnnualLeave" runat="server">
                                                    <ComponentArt:Calendar ID="OffPickerFrom1" runat="server" PickerFormat="Custom" PickerCustomFormat="yyyy-MM-dd  tt"
                                            ...
                                            <td>
                                                <span id="dvDays" runat="server">
                                                    <ComponentArt:Calendar ID="OffPickerTo1" runat="server" PickerFormat="Custom" PickerCustomFormat="yyyy-MM-dd  tt"
                                                        ControlType="Picker" PickerCssClass="picker">
                                                    </ComponentArt:Calendar>
                                                </span>
                                            </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:Button ID="btnOffSubmit" Text=" 提交本次事由 "  runat="server"
                                         OnClick="btnOffSubmit_Click" OnClientClick="return SubmitCheckOffTune();"/>&nbsp;
