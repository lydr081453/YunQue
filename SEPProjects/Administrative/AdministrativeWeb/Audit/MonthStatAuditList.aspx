<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthStatAuditList.aspx.cs" Inherits="AdministrativeWeb.Audit.MonthStatAuditList" MasterPageFile="~/Default.Master" %>
            ...
            <td>
                <table width="100%" border="0" cellspacing="0">
                    <tr>
                        ...
                        <td align="left" >&nbsp;<asp:DropDownList ID="drpYear" runat="server" />年
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <td class="td">
                            <ComponentArt:Grid ID="Grid1"
                                ...
                                <Levels>
                                    <ComponentArt:GridLevel
                                        ...
                                        <Columns>
                                            ...
                                            <ComponentArt:GridColumn HeadingText="选择" AllowSorting="True" DataCellClientTemplateId="checkTemplate"  Align="Center" />
                                            <ComponentArt:GridColumn HeadingText="姓名" AllowSorting="True" DataField="ApplicantName" Align="Center"  />
                                            ...
                                            <ComponentArt:GridColumn HeadingText="年假(补)" AllowSorting="True" DataField="LastAnnualDays" DataCellServerTemplateId="LastAnnualDaysTemplate" Align="Center" />
                                            ...
                                            <ComponentArt:GridColumn HeadingText="考勤状态" AllowSorting="True" DataField="AttendanceSubType" Align="Center" DataCellServerTemplateId="DeductSumTemplate" />
                                            <ComponentArt:GridColumn HeadingText="审批" AllowSorting="True" DataCellClientTemplateId="auditTemplate" Align="Center" />
                                        </Columns>
                                    </ComponentArt:GridLevel>
                                </Levels>
                                <ClientTemplates>
                                    ...
                                    <ComponentArt:ClientTemplate ID="ClientTemplate3">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td align="left">
                                                    <input type="checkbox" id="chkAll" onclick="checkedAll();" />全选</td>
                                            </tr>
                                        </table>
                                    </ComponentArt:ClientTemplate>
                                ...
                                <ServerTemplates>
                                    ...
                                    <ComponentArt:GridServerTemplate ID="LastAnnualDaysTemplate">
                                        <Template>
                                            <%# GetTimeInfo(Container.DataItem["LastAnnualDays"].ToString())%>
                                        </Template>
                                    </ComponentArt:GridServerTemplate>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:ImageButton ID="btnOverrule" runat="server" OnClientClick="return submitMatter(DataItem, 2);"
