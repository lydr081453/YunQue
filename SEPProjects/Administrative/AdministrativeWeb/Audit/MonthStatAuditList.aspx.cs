...
{
    public partial class MonthStatAuditList : ESP.Web.UI.PageBase
    {
        ...
        protected void BindInfo()
        {
            ...
            if (!string.IsNullOrEmpty(Request["type"]))
            {
                ...
                DataSet ds = new ApproveLogManager().GetApproveList(ApproveUserID, status, int.Parse(drpYear.SelectedItem.Value), int.Parse(drpMonth.SelectedItem.Value), strBuilder.ToString(), parameterList);
