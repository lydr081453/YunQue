<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutMatterEdit.aspx.cs" Inherits="AdministrativeWeb.Audit.OutMatterEdit" MasterPageFile="~/Default.Master" %>
		    ...
		    <tr>
		        ...
		        <td class="mpc">
                    <ComponentArt:MultiPage ID="MultiPage1" runat="server" Width="100%">
                        ...
                        <ComponentArt:PageView>
                            <p>
                                <Matters:OtherEdit ID="matOther" runat="server" Visible="false"/>
                            </p>
                        </ComponentArt:PageView>                     
