...
{
    public partial class HRTimeSheetAudit : ESP.Web.UI.PageBase
    {
        string userid = "";
        ...
        public WeekInfoList GetWeekInfoList()
        {
            ...
            string terms = " userid = " + userid + " and commitType <> '" + ESP.Administrative.Common.TimeSheetCommitType.Holiday.ToString() + "' and status=" + (int)ESP.Administrative.Common.TimeSheetCommitStatus.WaitHR; 
        ...
        private void ListBind()
        {
            ...
            string terms = " and a.userId = " + userid + " and a.commitType='" + ESP.Administrative.Common.TimeSheetCommitType.Holiday.ToString() + "' and a.status =" + (int)ESP.Administrative.Common.TimeSheetCommitStatus.WaitHR;
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (audit((int)ESP.Administrative.Common.TimeSheetCommitStatus.Commit))
            {
                Response.Redirect("HRTimeSheetAuditList.aspx");
            }
