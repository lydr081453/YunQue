<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RewardLeaveList.aspx.cs" Inherits="AdministrativeWeb.Attendance.RewardLeaveList" 
                    ...
                    <tr>
                        <td class="td">
                            <ComponentArt:Grid ID="Grid1" 
                                ...
                                GroupingNotificationText="福利假统计信息" 
                                HeaderHeight="30" 
                                ...
                                OnInsertCommand="Grid1_InsertCommand"
                                OnDeleteCommand="Grid1_DeleteCommand"
                                ...
                                <Levels>
                                    <ComponentArt:GridLevel DataKeyField="ID" 
                                        ...
                                        <Columns>
                                            ...
                                            <ComponentArt:GridColumn AllowEditing="False" HeadingText="姓名" DataField="EmployeeName" Align="Center" Width="50" />
                                            <ComponentArt:GridColumn HeadingText="员工编号" DataField="UserCode" Align="Center" Width="55" />
                                            <ComponentArt:GridColumn AllowEditing="False" HeadingText="职位" DataField="DepartmentPositionName" Align="Center" DataType="System.String" />
                                            <ComponentArt:GridColumn AllowEditing="False" HeadingText="部门" DataField="DepartmentName" Align="Center" DataType="System.String" />
                                            <ComponentArt:GridColumn HeadingText="年份"  DataField="LeaveYear" Align="Center" DataType="System.String" Width="55" />
                                            <ComponentArt:GridColumn HeadingText="福利假总数" DataField="LeaveNumber" DataType="System.String" Align="Center" />
                                            <ComponentArt:GridColumn HeadingText="剩余福利假数" DataField="RemainingNumber" DataType="System.String" Align="Center" />
                                            <ComponentArt:GridColumn AllowSorting="false" HeadingText="编辑" DataCellClientTemplateId="EditTemplate" EditControlType="EditCommand" Width="150" Align="Center" />
                                        </Columns>
