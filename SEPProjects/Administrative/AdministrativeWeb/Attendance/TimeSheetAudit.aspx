<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="TimeSheetAudit.aspx.cs" Inherits="AdministrativeWeb.Attendance.TimeSheetAudit" %>
                        ...
                        <td class="week_list">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="80" valign="top" class="item">
                                        <span title="<%=timesheet.ProjectName%>"><%=timesheet.ProjectCode%></span>
                                    </td>
                                    <td valign="top" class="description">
                                        <%=timesheet.WorkItem%>
                                    </td>
                                    <td width="25" align="center" class="item">
