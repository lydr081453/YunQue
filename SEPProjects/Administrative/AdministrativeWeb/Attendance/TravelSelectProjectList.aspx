<%@ Page Title="项目号列表" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" Inherits="AdministrativeWeb.Attendance.TravelSelectProjectList" Codebehind="TravelSelectProjectList.aspx.cs" %>
<%@ OutputCache Duration="1" Location="none" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<script language="javascript">

    function SelectProject(projectId, projectCode) {
        window.opener.setTravelProjectInfo(projectId, projectCode);
        window.close();
    }
</script>
<table width="100%" class="tableForm">
    ...
    <asp:GridView ID="gvProject" runat="server" AutoGenerateColumns="false" DataKeyNames="ProjectId" OnRowDataBound="gvProject_RowDataBound" Width="100%" CellPadding="4">
