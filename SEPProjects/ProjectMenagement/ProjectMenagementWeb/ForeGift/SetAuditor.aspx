<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="ForeGift_SetAuditor" EnableEventValidation="false" Codebehind="SetAuditor.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function openEmployee(type) {
        ...
        var win = window.open('/Purchase/selectOperationAuditor.aspx?<% =ESP.Finance.Utility.RequestName.ReturnID %>=<%=Request[ESP.Finance.Utility.RequestName.ReturnID] %>&curU=' + currentUser + "&type=" + type, null, 'height=600px,width=800px,scrollbars=yes,top=100px,left=100px');
        win.resizeTo(screen.availWidth * 0.8, screen.availHeight * 0.8);
    }
    function openEmployee1(type, changedTrId, oldId) {
        var currentUser = '<%= CurrentUser.SysID %>';
        var win = window.open('/Purchase/selectOperationAuditor.aspx?<% =ESP.Finance.Utility.RequestName.ReturnID %>=<%=Request[ESP.Finance.Utility.RequestName.ReturnID] %>&changedTrId=' + changedTrId + '&oldId=' + oldId + '&type=' + type + '&curU=' + currentUser, null, 'height=600px,width=800px,scrollbars=yes,top=100px,left=100px');
        win.resizeTo(screen.availWidth * 0.8, screen.availHeight * 0.8);
    }
    </script>
    ...
    <table border="0" width="100%">
        <tr>
            <td align="center">
                <input runat="server" id="btnCommit" value=" 提交 " type="button" onclick="showLoading();"
