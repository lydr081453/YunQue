<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="RebateRegistrationAudit.aspx.cs" Inherits="FinanceWeb.RebateRegistration.RebateRegistrationAudit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   function setLoading(button) {
    ...
    <table width="100%" class="tableForm">
        ...
        <tr>
            <td class="oddrow" style="width: 15%">审批备注: </td>
            <td class="oddrow-l" colspan="3">
                <asp:TextBox runat="server" ID="txtAudit" TextMode="MultiLine" Width="65%" Height="50px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="background-color: white;" colspan="4" align="center">
                ...
                <asp:Button ID="btnPass" runat="server" Text=" 审批通过 " OnClick="btnPass_Click"  OnClientClick="return ConfirmAudit();" CssClass="widebuttons" />&nbsp;&nbsp;
                <asp:Button ID="btnReject" runat="server" Text=" 审批驳回 " OnClick="btnReject_Click"  OnClientClick="return CancelAudit();" CssClass="widebuttons" />&nbsp;&nbsp;
