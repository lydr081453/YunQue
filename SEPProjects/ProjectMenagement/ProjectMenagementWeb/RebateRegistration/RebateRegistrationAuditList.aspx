<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="RebateRegistrationAuditList.aspx.cs" Inherits="FinanceWeb.RebateRegistration.RebateRegistrationAuditList" %>
...
<link href="/public/css/gridViewStyle.css" rel="stylesheet" type="text/css" />
    <uc1:AuditTab id="AuditTab" runat="server" TabIndex="10" />
    <br />
    <table width="100%">
        <tr>
