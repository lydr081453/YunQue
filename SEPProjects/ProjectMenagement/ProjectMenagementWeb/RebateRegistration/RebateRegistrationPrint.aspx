<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RebateRegistrationPrint.aspx.cs" Inherits="FinanceWeb.RebateRegistration.RebateRegistrationPrint" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr>
                ...
                <td align="center" colspan="5" valign="middle" style="padding: 0 0 5px 0; font-size: 24px;">媒体返点批次打印
                </td>
            </tr>
        </table>
        <br />
        <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr style="height: 20px">
             ...
             <tr style="height: 20px">
              ...
              <tr style="height: 20px">
                <td class="test_title_right" style="font-size: 15px">返点总额
                </td>
                <td colspan="3" class="test_title_right" style="font-size: 15px">
        ...
        <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
            <asp:Repeater ID="repExpense" runat="server" OnItemDataBound="repExpense_ItemDataBound">
                <HeaderTemplate>
                    <tr>
                        <td width="12%" align="center" class="test_title_right" style="font-size: 12px">年月
                        </td>
                        <td width="15%" align="center" class="test_title_right" style="font-size: 12px">项目号
                        </td>
                        <td width="25%" align="center" class="test_title_right" style="font-size: 12px">媒体主体
                        </td>
                        <td align="center" class="test_title_right" style="font-size: 12px">返点内容
                        </td>
                        <td width="12%" align="center" class="test_title_right" style="font-size: 12px">申请金额
                        </td>
                        <td align="center" class="test_title_right" style="font-size: 12px">返点核算信息编号
                        </td>
                        <td align="center" class="test_title_right" style="font-size: 12px">结算类型
                        </td>
                        <td align="center" class="test_title_right" style="font-size: 12px">我方主体名称
                        </td>
                    </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td align="center" class="f12pxGgray" style="font-size: 12px">
                            <asp:Literal ID="lblMedia" runat="server" />
                        </td>
                        <td align="center" class="f12pxGgray" style="font-size: 12px">
                        ...
                        <td align="center" class="f12pxGgray_right" style="font-size: 12px">
                            <asp:Literal ID="labNum" runat="server" />
                        </td>
                        <td align="center" class="f12pxGgray_right" style="font-size: 12px">
                            <asp:Literal ID="labType" runat="server" />
                        </td>
                                                <td align="center" class="f12pxGgray_right" style="font-size: 12px">
                            <asp:Literal ID="labBranch" runat="server" />
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <tr>
                <td colspan="7" align="right" class="test_title_right" style="font-size: 15px; background-color: #66ff99;">合计：<asp:Literal ID="litTotal" runat="server" /></td>
            </tr>
        </table>
        <br />
        <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
