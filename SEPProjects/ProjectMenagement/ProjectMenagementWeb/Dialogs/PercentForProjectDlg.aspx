<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    Title="预计完成百分比" CodeBehind="PercentForProjectDlg.aspx.cs" Inherits="ProjectMenagementWeb.Dialogs.PercentForProjectDlg" %>
        ...
        <tr>
            <td class="heading">
                <asp:GridView ID="gv" runat="server" OnRowDataBound="gv_RowDataBound" AutoGenerateColumns="false"
                    DataKeyNames="ScheduleID" Width="100%" CellPadding="4">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="百分比%" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPercent" runat="server" OnTextChanged="txtPercent_TextChanged"
    ...
    <table width="100%" class="tableForm" id="Table1">
        ...
        <tr>
            <td align="center" colspan="4">
                <asp:Button ID="btnAutoCreate" runat="server" Text="平均分配未填百分比" CssClass="widebuttons" Visible="false"
                    OnClick="btnAutoCreate_Click" />
                <asp:Button ID="btnNewSupporter" runat="server" Text="保存" class="widebuttons" OnClick="btnNewSupporter_Click" />
