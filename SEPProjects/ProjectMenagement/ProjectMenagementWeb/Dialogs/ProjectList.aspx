<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    Inherits="Dialogs_ProjectList" Title="项目选择" CodeBehind="ProjectList.aspx.cs" %>
            ...
            <td>
                <asp:GridView ID="gvProject" runat="server" AutoGenerateColumns="False" DataKeyNames="ProjectID"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ApplicantEmployeeName" HeaderText="负责人" /> 
                        <asp:TemplateField HeaderText="成本所属组" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
