<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Title="客户历史信息" Inherits="Dialogs_CustomerHistoryDlg" Codebehind="CustomerHistoryDlg.aspx.cs" %>
...
<%--            <td class="oddrow" style="width: 15%">
        ...
        <tr>
            <td colspan="4" align="center">
                <asp:Button ID="btnSubmit" runat="server" Text=" 确定 " class="widebuttons" OnClick="btnSubmit_Click" />&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnClose" runat="server" Text=" 关闭 " class="widebuttons" OnClick="btnClose_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
