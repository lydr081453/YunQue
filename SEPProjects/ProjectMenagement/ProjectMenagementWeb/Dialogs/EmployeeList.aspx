<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" Inherits="Purchase_Requisition_EmployeeList" Title="选择人员" AutoEventWireup="true" EnableEventValidation="false" Codebehind="EmployeeList.aspx.cs" %>
...
//            $("#<%=ddltype2.ClientID %>").append("<option value=\"-1\" selected>请选择...</option>");
    ...
    function selectAll(obj) {
        ...
        for (i = 0; i < theTable.rows.length; i++) {
            ...
            var objCheckBox = theTable.rows[i].cells[j].querySelector("input[type='checkbox']");
    ...
    <table width="100%" class="tableForm">
        ...
        <tr>
            ...
            <td class="oddrow-l"><asp:DropDownList ID="ddltype" Width="100px" runat="server"  AutoPostBack="false" />
                            ...
                            <asp:HiddenField ID="hidGroupName" Value=""  runat="server" /></td>
        </tr>
        <tr>
    ...
    <asp:GridView ID="gv" runat="server" OnDataBinding="gv_DataBinding" OnRowDataBound="gv_RowDataBound" AutoGenerateColumns="false" DataKeyNames="SysUserID"  Width="100%" CellPadding="4">
        ...
        <Columns>
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60">
                   ...
                   <HeaderTemplate>
                      <input id="CheckAll" type="checkbox" onclick="selectAll(this);" style="visibility:<%= this.Request["showSelectAll"] %>" />选择
                    </HeaderTemplate>
             </asp:TemplateField>
