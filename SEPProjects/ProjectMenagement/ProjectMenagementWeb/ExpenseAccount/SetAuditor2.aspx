<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="ExpenseAccount_SetAuditor2" EnableEventValidation="false" CodeBehind="SetAuditor2.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript">
        ...
        function getInsertIndex(type) {
            ...
            for (i = 1; i < table.rows.length; i++) {
                if (table.rows[i].cells[4].innerHTML == getAuditorTypeName("YS")) {
                    ysIndex = i;
                }   else if (table.rows[i].cells[4].innerHTML == getAuditorTypeName("FZR")) {
                    fzrIndex = i;
        ...
        function openEmployee(type) {
            ...
            var win = window.open('selectOperationAuditor2.aspx?<% =ESP.Finance.Utility.RequestName.ReturnID %>=<%=Request["id"] %>&curU=' + currentUser + "&type=" + type, null, 'height=600px,width=800px,scrollbars=yes,top=100px,left=100px');
            win.resizeTo(screen.availWidth * 0.8, screen.availHeight * 0.8);
        }
        function openEmployee1(type, changedTrId, oldId) {
            var currentUser = '<%= CurrentUser.SysID %>';
            var win = window.open('selectOperationAuditor2.aspx?<% =ESP.Finance.Utility.RequestName.ReturnID %>=<%=Request["id"] %>&changedTrId=' + changedTrId + '&oldId=' + oldId + '&type=' + type + '&curU=' + currentUser, null, 'height=600px,width=800px,scrollbars=yes,top=100px,left=100px');
            win.resizeTo(screen.availWidth * 0.8, screen.availHeight * 0.8);
        }
    </script>
