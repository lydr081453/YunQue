<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectedProjectCode.aspx.cs" Inherits="FinanceWeb.ExpenseAccount.SelectedProjectCode" MasterPageFile="~/MasterPage.master"%>
...
<table width="100%" class="tableForm">
    ...
    <tr>
        ...
        <td class="oddrow-l" style="width:85%" colspan="3"><asp:TextBox ID="txtProjectCode" runat="server" /><asp:TextBox ID="txtPA" runat="server" Visible="false" /></td>
