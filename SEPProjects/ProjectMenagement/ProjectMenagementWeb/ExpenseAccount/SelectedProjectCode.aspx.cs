...
{
    public partial class SelectedProjectCode : ESP.Web.UI.PageBase
    {
        ...
        private void ListBind()
        {
            ...
            if (!OperationAuditManageManager.GetCurrentUserIsManager(CurrentUser.SysID) 
                ...
                && !(ESP.Configuration.ConfigurationManager.SafeAppSettings["ProjectAdministrativeIDs"].IndexOf("," + deptid + ",") >= 0)
                && !(ESP.Configuration.ConfigurationManager.SafeAppSettings["SpecialDeptIDs"].IndexOf("," + deptid + ",") >= 0)
                )
            {
            ...
            if (ESP.Configuration.ConfigurationManager.SafeAppSettings["ProjectAdministrativeIDs"].IndexOf("," + deptid + ",") >= 0 || ESP.Configuration.ConfigurationManager.SafeAppSettings["SpecialDeptIDs"].IndexOf("," + deptid + ",") >= 0)
            {
            ...
            if (ESP.Configuration.ConfigurationManager.SafeAppSettings["ProjectAdministrativeIDs"].IndexOf("," + deptid.ToString() + ",") >= 0)
            {
                foreach (ESP.Finance.Entity.BranchInfo branch in branchList)
                {
                    ...
                    newProject.ProjectCode = branch.BranchCode + "-" + "GM**-*-" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString("00") + "001";
        ...
        private void add(string projectId)
        {
            ...
            else
            {
                ...
                Response.Write("<script>window.opener.setProjectInfo('0','" + projectId + "','','" + depts + "');</script>");
            }
