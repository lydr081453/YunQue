<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchExpenseAccountView.aspx.cs" Inherits="FinanceWeb.ExpenseAccount.SearchExpenseAccountView" MasterPageFile="~/MasterPage.master"%>
        ...
        <td class="oddrow">
            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,ReturnID"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ExpenseTypeNumber" HeaderText="单位数量" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" />
