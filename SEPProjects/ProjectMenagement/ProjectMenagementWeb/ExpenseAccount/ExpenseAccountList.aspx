<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpenseAccountList.aspx.cs" Inherits="FinanceWeb.ExpenseAccount.ExpenseAccountList" MasterPageFile="~/MasterPage.master" %>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="oddrow-l" colspan="4">
                            <li>
                                <asp:LinkButton ID="lbNewProject" runat="server" Text="创建报销申请单" OnClick="lnkNew_Click" /></li>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td class="oddrow">
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="ReturnID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="报销单号" ItemStyle-HorizontalAlign="Center" >
                                                    <ItemTemplate>
                                                        <a href="Display.aspx?id=<%#Eval("ReturnID") %>">
                                                            <%#Eval("ReturnCode")%></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="PreFee" HeaderText="预计报销金额" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:f2}" />
                                                <asp:BoundField DataField="FactFee" HeaderText="实际报销金额" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:f2}" />
                                                ...
                                                <asp:TemplateField HeaderText="实际报销金额" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="labFactFee"  />
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
                                                ...
                                                <asp:TemplateField HeaderText="删除" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center"
                                                    ItemStyle-Width="4%">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnDelete" runat="server" Text="<img title='删除报销申请' src='../../images/disable.gif' border='0' />"
