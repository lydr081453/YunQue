<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MajorExpenseAccountList.aspx.cs"
    Inherits="FinanceWeb.ExpenseAccount.MajorExpenseAccountList" Theme="" MasterPageFile="~/MasterPage.master" %>
                                ...
                                <Levels>
                                    <ComponentArt:GridLevel DataKeyField="WorkItemID" ShowTableHeading="false" TableHeadingCssClass="GridHeader"
                                        ...
                                        <Columns>
                                            ...
                                            <ComponentArt:GridColumn HeadingText="申请单号" DataField="ReturnCode" Align="Center" Width="90" />
                                            <ComponentArt:GridColumn HeadingText="项目号" DataField="ProjectCode" Align="Center" Width="115" />
                                            <ComponentArt:GridColumn HeadingText="项目名称" DataField="ReturnContent" Align="Center" Width="60" />
                                            <ComponentArt:GridColumn HeadingText="费用所属组" DataField="DepartmentName" Align="Center" Width="60" />
                                            <ComponentArt:GridColumn HeadingText="预计报销金额" DataField="PreFee" Align="Right" FormatString="0.00" Width="80" />
                                            ...
                                            <ComponentArt:GridColumn HeadingText="业务审批通过日期" DataField="LastAuditPassTime" Align="Center"
                                                FormatString="yyyy-MM-dd" Width="80" />
                                            <ComponentArt:GridColumn HeadingText="单据类型" DataField="ReturnTypeName" Align="Center" Width="50" />
                                       ...
                                       <ComponentArt:GridLevel DataKeyField="ID" ShowTableHeading="false" TableHeadingCssClass="GridHeader"
                                        ...
                                        <Columns>
                                            ...
                                            <ComponentArt:GridColumn DataField="ReturnID" Visible="false" />
                                            <ComponentArt:GridColumn HeadingText="费用发生日期" DataField="ExpenseDate" FormatString="yyyy-MM-dd" Align="Center" />
        ...
        <uc1:TabPanel ID="TabPanel2" HeaderText="已审批项" runat="server">
            <ContentTemplate>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
                    <tr>
                        <td class="td">
                            <ComponentArt:Grid ID="GridHist" DataAreaCssClass="GridData" CssClass="Grid" EnableViewState="true"
                                GroupingMode="ConstantGroups" GroupByTextCssClass="HeadingCellText" GroupBySectionCssClass="grp"
