<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisplayByOpen.aspx.cs" Inherits="FinanceWeb.ExpenseAccount.DisplayByOpen" MasterPageFile="~/MasterPage.master"%>
...
<table width="100%" class="tableForm">
    ...
    <tr>
        <td class="oddrow-l" colspan="4">
            <asp:Button ID="btnReturn" runat="server" Text=" 关闭 " CssClass="widebuttons" OnClientClick="window.close();" CausesValidation="false" />
        </td>
    </tr>
</table>
