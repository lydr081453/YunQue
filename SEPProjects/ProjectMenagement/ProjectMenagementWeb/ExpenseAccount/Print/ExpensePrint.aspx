    ...
    <form id="form1" runat="server">
        ...
        <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr>
                <td colspan="8">
                    <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr style="height: 20px">
                            <td class="test_title_right" style="font-size: 15px;">项目号
                            </td>
                        ...
                        <tr style="height: 20px">
                            <td class="test_title_right" style="font-size: 15px;">开户银行
                            </td>
                            <td class="f12pxGgray_right" style="font-size: 15px;">
                                <asp:Literal ID="litBank" runat="server" />
                            </td>
                            <td class="test_title_right" style="font-size: 15px;">银行账号
                            </td>
                            <td class="f12pxGgray_right" style="font-size: 15px;">
                        ...
                        <tr style="height: 20px">
                            <td class="test_title_right" style="font-size: 15px;">费用所属组
                            </td>
            ...
            <tr style="height: 40px;">
                <td align="center" class="test_title_right" style="font-size: 15px;">费用发生日期</td>
                <td colspan="6" align="center" class="test_title_right" style="font-size: 15px;">费用明细描述</td>

                <td align="center" class="test_title_right" style="font-size: 15px; width: 110px;">申请金额</td>
            </tr>
            ...
            <tr>
                ...
                <td align="center" height="20" class="f12pxGgrayBold" colspan="6" style="font-size: 15px; background-color: #66ff99;">合计:</td>
