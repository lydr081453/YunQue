<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketPrint.aspx.cs" Inherits="FinanceWeb.ExpenseAccount.Print.TicketPrint" %>
    ...
    <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="50" id="btnPrint" runat="server" align="center" valign="bottom" background="images/btnbgimg (1).gif"
                class="white_font">
                <a style="cursor: pointer; color: Blue; text-decoration: underline;" onclick="javascript:window.print();">
                    打印</a>
            </td>
            <td width="1">
            ...
            <td width="50" id="btnClose" runat="server" align="center" valign="bottom" background="images/btnbgimg (1).gif"
                class="white_font">
                <a style="cursor: pointer; color: Blue; text-decoration: underline;" onclick="javascript:window.close();">
                    关闭</a>
            </td>
        </tr>
    </table>
