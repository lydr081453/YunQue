<%@ Page Language="C#" AutoEventWireup="true" Inherits="ExpenseAccount_Print_ThirdPartyPrint"
    CodeBehind="ThirdPartyPrint.aspx.cs" %>
...
<body>
    ...
    <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
        <asp:Repeater ID="rep1" runat="server" OnItemDataBound="rep1_ItemDataBound">
            <HeaderTemplate>
                <tr style="height:40px">
                   <td width="20%" align="center" class="test_title_right" style="font-size: 15px">
                        费用发生日期
                    </td>
                    <td align="center" class="test_title_right" style="font-size: 15px">
                        费用明细描述
                    </td>
            ...
            <ItemTemplate>
                ...
                <tr style="height:40px">
                    ...
                    <td align="center" class="f12pxGgray_right" style="font-size: 15px">
        ...
        <tr>
            <td colspan="3" align="right" class="test_title_right" style="font-size: 15px;background-color: #66ff99;">合计：<asp:Literal ID="litTotal" runat="server" /></td>
        </tr>
    </table>
    <br />
        <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
