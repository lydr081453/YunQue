<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmTicket.aspx.cs"
    Inherits="FinanceWeb.ExpenseAccount.ConfirmTicket" %>
...
<body>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td align="center" height="20px" class="f12pxGgray_left" style="font-size: 12px;">
                                    ...
                                    <asp:HiddenField  runat="server" id="hidExpenseId"/>
                                </td>
                                ...
                                <td align="right" class="f12pxGgray_right" style="font-size: 12px;">
                                    <asp:TextBox runat="server" ID="txtFee"></asp:TextBox>&nbsp;
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="left" colspan="3" height="20px" class="f12pxGgray_left" style="font-size: 12px;">
    ...
    <table width="630px" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="50" id="Td1" runat="server" align="center" valign="bottom" background="/images/btnbgimg (1).gif"
                class="white_font">
                <asp:LinkButton runat="server" ForeColor="Blue" Font-Underline="true" ID="btnConfirm" Text=" 确认订单 " OnClick="btnConfirm_Click"></asp:LinkButton>
            </td>
              <td width="1">
                <img src="/images/space.gif" width="1" height="1" />
            </td>
            <td width="50" id="btnPrint" runat="server" align="center" valign="bottom" background="/images/btnbgimg (1).gif"
                class="white_font">
                <asp:LinkButton runat="server" ForeColor="Blue" Font-Underline="true" ID="LinkButton1" Text=" 打印 " OnClick="btnPrint_Click"></asp:LinkButton>
            </td>
            <td width="1">
                <img src="/images/space.gif" width="1" height="1" />
            </td>
            <td width="50" id="btnClose" runat="server" align="center" valign="bottom" background="/images/btnbgimg (1).gif"
                class="white_font">
                <a style="cursor: pointer;color:Blue;text-decoration:underline;" onclick="javascript:window.close();">关闭</a>
            </td>
        </tr>
    </table>
    </form>
