<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ConsumptionList.aspx.cs" Inherits="FinanceWeb.Consumption.ConsumptionList" %>
                ...
                <table width="100%" class="tableForm">
                    ...
                    <tr>
                        ...
                        <td class="oddrow-l" colspan="2">
                            ...
                            <asp:Button ID="btnImport" runat="server" Text=" 消耗导入 " CssClass="widebuttons" OnClick="btnImport_Click" />
                            <asp:Button ID="btnAdj" runat="server" Text=" 消耗调整 " CssClass="widebuttons" OnClick="btnAdj_Click" />
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <asp:GridView ID="GvImport" runat="server" AutoGenerateColumns="False" OnRowDataBound="GvImport_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                     ...
                                     <asp:TemplateField HeaderText="类型" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="8%">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="审批状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="8%">
                                        <ItemTemplate>
                                            <a href="/project/ProjectWorkFlow.aspx?Type=consumption&FlowID=<%#Eval("BatchID") %>" target="_blank">
                                    ...
                                    <asp:TemplateField HeaderText="查看" ItemStyle-Width="7%">
                                        ...
                                        <ItemTemplate>
                                            <a href="ConsumptionView.aspx?batchId=<%#Eval("BatchID") %>">
                                    ...
                                    <asp:TemplateField HeaderText="打印" ItemStyle-Width="7%">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <a target="_blank" href="ConsumptionPrint.aspx?batchId=<%#Eval("BatchID") %>">
