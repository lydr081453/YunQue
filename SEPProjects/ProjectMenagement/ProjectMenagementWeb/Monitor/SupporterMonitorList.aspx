<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeBehind="SupporterMonitorList.aspx.cs" Inherits="Monitor_SupporterMonitorList" %>
                                        ...
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="SupportID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-HorizontalAlign="Center" />
                                                 <asp:BoundField DataField="SupporterCode" HeaderText="流水号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />
                                                ...
                                                <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%">
                                                    <ItemTemplate>
                                                        <a target="_blank" href="/project/SupporterDisplay.aspx?<% =ESP.Finance.Utility.RequestName.SupportID %>=<%#DataBinder.Eval(Container.DataItem,"SupportID")%>&<% =ESP.Finance.Utility.RequestName.ProjectID %>=<%#DataBinder.Eval(Container.DataItem,"ProjectID")%>">
                                                  ...
                                                  <asp:TemplateField HeaderText="审批状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <a href="/project/ProjectWorkFlow.aspx?Type=supporter&FlowID=<%#Eval("SupportID") %>"   target="_blank">
                                                ...
                                                <asp:TemplateField HeaderText="打印预览" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%">
                                                    ...
                                                    <ItemTemplate>
                                                        <a href='/project/SupporterPrint.aspx?<% =ESP.Finance.Utility.RequestName.SupportID %>=<%#DataBinder.Eval(Container.DataItem,"SupportID")%>'
                                                            target="_blank">
                                                  ...
                                                  <asp:TemplateField HeaderText="成本" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                    <ItemTemplate>
                                                        <a href='/CostView/SupSinglePrjView.aspx?<% =ESP.Finance.Utility.RequestName.SupportID %>=<%#DataBinder.Eval(Container.DataItem,"SupportID")%>&<% =ESP.Finance.Utility.RequestName.ProjectID %>=<%#DataBinder.Eval(Container.DataItem,"ProjectID")%>'
                                                            target="_blank">
                                                            <img title="支持方申请单" src="/images/dc.gif" border="0px;" /></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
