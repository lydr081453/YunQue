<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="project_NewSetAuditor" Codebehind="NewSetAuditor.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script language="javascript">

        //预审，总监审批，总监知会，总经理审批，总经理知会
        ...
        function addUser(type, userId) {
            ...
            if (type != "ZJZH" && type != "ZJLZH") {
                ...
                hidCEO = document.getElementById("<%=hidCEO.ClientID %>").value;
                if (!checkExist(hidValue, userId) && !checkExist(hidYS, userId) && !checkExist(hidZJFJ, userId) && !checkExist(hidZJSP, userId) && !checkExist(hidZJLSP, userId) && !checkExist(hidZJLFJ, userId) && !checkExist(hidCEO, userId)) {
