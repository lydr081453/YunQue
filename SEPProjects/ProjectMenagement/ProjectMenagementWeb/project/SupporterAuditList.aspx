<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    Inherits="project_SupporterAuditList" CodeBehind="SupporterAuditList.aspx.cs" %>
                                        ...
                                        <asp:GridView ID="gridList" runat="server" AutoGenerateColumns="False" DataKeyNames="SupportID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="SupporterCode" HeaderText="申请单号" ItemStyle-HorizontalAlign="Center"
                                                    ItemStyle-Width="10%" />
                                                <asp:TemplateField HeaderText="业务组别" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                                    <ItemTemplate>
