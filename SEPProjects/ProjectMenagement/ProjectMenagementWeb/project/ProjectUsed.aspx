<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ProjectUsed.aspx.cs" Inherits="project_ProjectUsed" %>
                                    ...
                                    <td class="oddrow">
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="ProjectID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="启用" ItemStyle-Width="5%">
                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkUsed" runat="server" Font-Underline="true" OnClientClick="return confirm('您确定要启用该项目吗？');"
                                                            Text="<img title='启用' src='../../images/edit.gif' border='0' />"
                                                            CommandName="Used" CommandArgument='<%# Eval("projectid") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
