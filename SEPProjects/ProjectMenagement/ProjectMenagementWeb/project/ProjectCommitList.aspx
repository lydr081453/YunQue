<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    Inherits="project_ProjectCommitList" CodeBehind="ProjectCommitList.aspx.cs" %>
                                    ...
                                    <td class="oddrow">
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="ProjectID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="使用状态" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="撤销" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="ImgCancel" OnClientClick="return confirm('你确定撤销该项目号吗？');" runat="server" ImageUrl="~/images/Icon_Cancel.gif" Visible="false" CommandArgument='<%# Eval("ProjectID") %>' OnClick="ImgCancel_Click" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
