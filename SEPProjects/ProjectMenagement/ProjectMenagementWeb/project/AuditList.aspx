<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    Inherits="Project_AuditList" CodeBehind="AuditList.aspx.cs" %>
                                    ...
                                    <td class="oddrow">
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="ProjectID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="WorkItemID" HeaderText="WorkItemID" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="ProcessID" HeaderText="ProcessID" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="InstanceID" HeaderText="InstanceID" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="WorkItemName" HeaderText="WorkItemName" ItemStyle-HorizontalAlign="Center" />
                                                ...
                                                <asp:BoundField DataField="BusinessDescription" HeaderText="项目名称" ItemStyle-HorizontalAlign="Center"
                                                    ItemStyle-Width="15%" />
                                                <asp:TemplateField HeaderText="负责人" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="9%">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="使用状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="6%">
                                                    <ItemTemplate>
