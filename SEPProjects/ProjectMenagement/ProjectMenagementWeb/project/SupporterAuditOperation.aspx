<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    Inherits="project_SupporterAuditOperation" CodeBehind="SupporterAuditOperation.aspx.cs" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <table style="width: 100%">
        <tr>
            <td colspan="2">
                <li>
                    <asp:HyperLink ID="linkBack" runat="server" NavigateUrl="SupporterAuditList.aspx">返回支持方列表</asp:HyperLink></li>
            </td>
        </tr>
        <tr>
    ...
    <table width="100%">
        <tr>
            <td align="center">
                <asp:Button ID="btnSubmit" runat="server" Text=" 审批通过 " ValidationGroup="audit" CssClass="widebuttons"
                    OnClientClick="return AuditCheck();" OnClick="btnSubmit_Click" />
                <asp:Button ID="btnReject" runat="server" Text=" 审批驳回 " ValidationGroup="audit" CssClass="widebuttons"
                    OnClientClick="return AuditCheck();" OnClick="btnReject_Click" />
