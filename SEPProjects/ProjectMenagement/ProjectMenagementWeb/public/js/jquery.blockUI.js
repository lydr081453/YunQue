...
;(function($) {
    ...
    function install(el, opts) {
        ...
        // show the message
        lyr3.append("<div style='width:100%;'><button style='float:right;border:1px solid #222;background-color:#234567;color:white;line-height:10px;height:20px;font-weight:bold;' onclick='jQuery.unblockUI();'>ｘ</button></div>");
