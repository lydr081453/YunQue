<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ContractAuditList.aspx.cs" Inherits="FinanceWeb.ContractFiles.ContractAuditList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <uc1:AuditTab id="AuditTab" runat="server" TabIndex="7" />
    <br />
    <table width="100%">
        <tr>
