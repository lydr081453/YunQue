...
{
    public partial class ContractAuditList : ESP.Web.UI.PageBase
    {
        ...
        private void ListBind()
        {
            ...
            var data = this.AuditTab.Contracts;
            ...
            //var list = ESP.Finance.BusinessLogic.ProjectManager.GetContractAuditingProjectList();
        ...
        void grComplete_ItemDataBound(object sender, ComponentArt.Web.UI.GridItemDataBoundEventArgs e)
        {
            ...
            e.Item["AuditLink"] = "<a href='ContractAudit.aspx?" + ESP.Finance.Utility.RequestName.ProjectID + "=" + e.Item["ProjectID"] + "&&BackUrl=ContractAuditList.aspx'><img src='/images/Audit.gif' border='0px' /></a>";
