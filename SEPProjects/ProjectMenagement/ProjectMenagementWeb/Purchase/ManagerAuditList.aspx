<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Purchase_ManagerAuditList" CodeBehind="ManagerAuditList.aspx.cs" %>
                                        ...
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="ReturnID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="PN号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <a href="<%# int.Parse(Eval("returnType").ToString()) == (int)ESP.Purchase.Common.PRTYpe.PN_ForeGift ? "/ForeGift/ForegiftDetail.aspx" : "/Purchase/ReturnDisplay.aspx"  %>?<% =ESP.Finance.Utility.RequestName.ReturnID %>=<%#Eval("ReturnID") %>"
                                                            target="_blank">
                                                            <%#Eval("ReturnCode")%></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="8%" HeaderText="负责人"
                                                    ItemStyle-HorizontalAlign="Center">
                                                     <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblName" CssClass="userLabel" Text='<%# Eval("RequestEmployeeName") %>' />
                                                    </ItemTemplate>
                                                    </asp:TemplateField>
                                                <asp:BoundField DataField="ProjectCode" ItemStyle-Width="8%" HeaderText="项目号" ItemStyle-HorizontalAlign="Center" />
                                                ...
                                                <asp:TemplateField HeaderText="起始时间" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblBeginDate" Text='<%# Eval("PReBeginDate") == null ? "" : DateTime.Parse(Eval("PReBeginDate").ToString()).ToString("yyyy-MM-dd") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="结束时间" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblEndDate" Text='<%# Eval("PReEndDate") == null ? "" : DateTime.Parse(Eval("PReEndDate").ToString()).ToString("yyyy-MM-dd")  %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="付款状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="6%">
                                                    <ItemTemplate>
                                                        <%# ESP.Finance.Utility.ReturnPaymentType.ReturnStatusString(int.Parse(Eval("ReturnStatus").ToString()),0,null)%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="审批" ItemStyle-Width="6%">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemTemplate>
