<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="Purchase_ReturnEdit" EnableEventValidation="false" Codebehind="ReturnEdit.aspx.cs" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript">
        ...
        $().ready(function() {
            ...
            Purchase_ReturnEdit.GetPayments(initPayment);
