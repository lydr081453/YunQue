<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="returnDlgForPurchase.aspx.cs" Inherits="Purchase_returnDlgForPurchase" %>
        ...
        <tr>
            <td colspan="4" style="padding: 4px;">
                <table width="100%" class="tableForm">
                    ...
                    <tr>
                        <td class="oddrow">供应商名称:</td>
                        <td class="oddrow-l"><asp:TextBox ID="txtSupplierName" runat="server" /></td>
                    </tr>
                    <tr>
        ...
        <tr>
         ...
         <td class="oddrow-l" colspan="4">
           <asp:Button ID="Button1" runat="server" Text=" 确定 " CssClass="widebuttons" OnClick="btnCreate_Click" />
                            <asp:Button ID="Button2" runat="server" Text=" 关闭 " CssClass="widebuttons"
                                OnClick="btnClose_Click" />
         </td>
        </tr>
    </table>
