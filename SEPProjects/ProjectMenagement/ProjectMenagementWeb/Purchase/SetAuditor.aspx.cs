...
public partial class Purchase_SetAuditor : ESP.Web.UI.PageBase
{
    int returnId = 0;
    ...
    private void ViewContorl(ESP.Finance.Entity.ReturnInfo model)
    {
        ...
        ESP.Framework.Entity.DepartmentInfo deptModel = ESP.Framework.BusinessLogic.DepartmentManager.Get(deptId);
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        string backUrl = string.IsNullOrEmpty(Request["backUrl"]) ? "ReturnEdit.aspx" : "CreateNewPayment.aspx";
