<%@ Page Language="C#" AutoEventWireup="true" Inherits="Purchase_Print_PaymantPrint" Codebehind="PaymantPrint.aspx.cs" %>
...
<form id="form1" runat="server">
    ...
    <tr>
    <td colspan="3" height="80" valign="bottom" style="padding:0 0 5px 0"><asp:Image  runat="server" id="logoImg"  /></td>
  ...
  <tr>
    ...
    <td width="170px" align="center" class="test_title_right" style=" font-size:12px;">费用明细描述</td>
