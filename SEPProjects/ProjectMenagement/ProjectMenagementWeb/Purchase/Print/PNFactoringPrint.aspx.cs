...
{
    public partial class PNFactoringPrint : ESP.Web.UI.PageBase
    {
        ...
        private void initPrintPage()
        {
            ...
            if (bankModel != null)
            {
                labAccountName.Text = bankModel.BankAccountName;
                labAccountBankName.Text = bankModel.BankName;
                labAccountBankNo.Text = bankModel.BankAccount;
            }
            else
            {
