<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeBehind="BatchRepayEdit.aspx.cs" Inherits="FinanceWeb.Purchase.BatchRepayEdit" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <table style="width: 100%">
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="oddrow-l" colspan="3">
                <asp:TextBox ID="txtRemark" runat="server" TextMode="MultiLine" Width="80%" Height="80px"></asp:TextBox>
            </td>
        </tr>
        <tr>
    ...
    <table width="100%">
        <tr>
            <td align="center">
                <asp:Button ID="btnCommit" Text=" 提交 " runat="server" CssClass="widebuttons"  OnClick="btnCommit_Click" />
                &nbsp;
                <asp:Button ID="btnReturn" Text=" 返回 " CssClass="widebuttons" runat="server" OnClick="btnReturn_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
