...
{
    public partial class FinanceRePay : ESP.Finance.WebPage.EditPageForReturn
    {
        ...
        {
            returnId = Convert.ToInt32(Request[RequestName.ReturnID]);
            ESP.Finance.Utility.UpdateResult result = ESP.Finance.BusinessLogic.ReturnManager.CancelToFinance(returnId, this.txtRemark.Text.Trim(), CurrentUser);
