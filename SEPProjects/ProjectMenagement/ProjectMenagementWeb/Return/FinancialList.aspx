<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="Return_FinancialList" Codebehind="FinancialList.aspx.cs" %>
                                    ...
                                    <td class="oddrow">
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="PaymentID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="发票登记" ItemStyle-Width="6%">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="hylSign" runat="server" ImageUrl="/images/InvoiceSign.gif" ToolTip="发票登记"
                                                            Width="4%"></asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
