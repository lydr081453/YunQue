<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRegistCompanyStep1.aspx.cs" Inherits="SupplierWeb.UserRegister.UserRegistCompanyStep1" %>
  ...
  <tr>
    <td height="150" background="../Images/reg_03-20.jpg" bgcolor="#5E89FA" style="background-repeat:repeat-x; background-position:bottom left;">
      ...
      <table width="760" border="0" align="center" cellpadding="0" cellspacing="3">
        <tr>
          <td height="30" align="right">公司名称(中文)：</td>
          <td><asp:TextBox ID="txtSupplierName" runat="server" CssClass="input_reg" MaxLength="100"></asp:TextBox>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                  ControlToValidate="txtSupplierName" Display="None" ErrorMessage="请填写公司名称(中文)"></asp:RequiredFieldValidator>
            </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td width="20%" height="30" align="right">名称(英文)：</td>
          <td width="20%">
            <asp:TextBox ID="txtSupplierNameEn" runat="server" CssClass="input_reg" MaxLength="100"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                  ControlToValidate="txtSupplierNameEn" Display="None" ErrorMessage="请填写名称(英文)"></asp:RequiredFieldValidator></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="20%" height="30" align="right">网址：</td>
          <td width="20%">
            <asp:TextBox ID="txtWebsite" runat="server" CssClass="input_reg" MaxLength="100"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                  ControlToValidate="txtWebsite" Display="None" ErrorMessage="网址格式有误" 
                  ValidationExpression="[a-zA-z]+://[^\s]*"></asp:RegularExpressionValidator></td>
          <td>例：http://www.sina.com.cn</td>
        </tr>
      </table>
