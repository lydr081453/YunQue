<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRegisterCompanyStep3.aspx.cs" Inherits="SupplierWeb.UserRegister.UserRegisterCompanyStep3" %>
  ...
  <tr>
    <td height="150" background="../Images/reg_03-20.jpg" bgcolor="#5E89FA" style="background-repeat:repeat-x; background-position:bottom left;">
      ...
      <table width="760" border="0" align="center" cellpadding="0" cellspacing="3">
          ...
          <td width="50%">
            ...
            <div class="fileinputs">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                  ControlToValidate="fileIntrofile" Display="None" ErrorMessage="请上传公司简介"></asp:RequiredFieldValidator>
            </td>
          <td width="30%">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="30" align="right">产品/服务介绍：</td>
          <td>
                <div class="fileinputs">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                  ControlToValidate="fileProductfile" Display="None" ErrorMessage="请上传产品/服务介绍"></asp:RequiredFieldValidator>
            </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="30" align="right">报价：</td>
          <td>
                <div class="fileinputs">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                  ControlToValidate="filePricefile" Display="None" ErrorMessage="请上传报价"></asp:RequiredFieldValidator>
            </td>
          <td></td>
        </tr>
      </table>
