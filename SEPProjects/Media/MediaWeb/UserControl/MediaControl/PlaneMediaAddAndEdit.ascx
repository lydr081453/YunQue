<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="UserControl_MediaControl_PlaneMediaAddAndEdit" Codebehind="PlaneMediaAddAndEdit.ascx.cs" %>
...
<table style="width: 100%;" border="1" class="tableForm">
    ...
    <tr>
        ...
        <td class="oddrow-l">
           ...
           <%-- <cc1:ExtCalendar ID="dpStartPublication" format="Y-m-d" runat="server" ></cc1:ExtCalendar>--%>
        </td>
        <td class="oddrow">
            截稿日期：
        </td>
