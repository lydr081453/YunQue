<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="UserControl_MediaControl_TvMediaAddAndEdit" Codebehind="TvMediaAddAndEdit.ascx.cs" %>
...
<script language="javascript">
    ...
    $().ready(function() {
        ...
        $("#<%=txtTvName.ClientID %>").change(function(){
            ESP.Media.BusinessLogic.MediaitemsManager.GetChannelNameByCnName($("#<%=txtTvName.ClientID %>").val(),popchan);
            function popchan(cr)
            {
        ...
        $("#<%=txtTvChannelName.ClientID %>").change(function(){
            ESP.Media.BusinessLogic.MediaitemsManager.GetTopicNameByCnName($("#<%=txtTvName.ClientID %>").val(),$("#<%=txtTvChannelName.ClientID %>").val(),poptopic);
