<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="UserControl_MediaControl_PlaneMediaContentsDisplay" Codebehind="PlaneMediaContentsDisplay.ascx.cs" %>
...
<asp:Panel Style="width: 100%" runat="server" ID="panelDetail">
    <table style="width: 100%;" border="1" class="tableForm">
        ...
        <tr>
            ...
            <td class="oddrow-l">
                <asp:Label ID="labProvince" runat="server" />/<asp:Label ID="labCity" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="oddrow">
