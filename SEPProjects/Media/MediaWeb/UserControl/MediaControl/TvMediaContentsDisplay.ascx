<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="UserControl_MediaControl_TvMediaContentsDisplay" Codebehind="TvMediaContentsDisplay.ascx.cs" %>
...
<asp:Panel Style="width: 100%" runat="server" ID="panelDetail">
    <table style="width: 100%" border="1" class="tableForm">
        ...
        <tr>
            ...
            <td class="oddrow-l" style="width: 30%">
             <asp:Label ID="LabMediumSort" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="oddrow" style="width: 20%">
        ...
        <tr>
            ...
            <td class="oddrow-l">
                <asp:Label runat="server" ID="labProvince" />/<asp:Label runat="server" ID="labCity"></asp:Label>
            </td>
        </tr>
        <%--        <tr>
            <td class="oddrow">
