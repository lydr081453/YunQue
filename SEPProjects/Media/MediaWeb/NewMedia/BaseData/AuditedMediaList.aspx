<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditedMediaList.aspx.cs" MasterPageFile="~/MasterPage.master" ValidateRequest="false" EnableEventValidation="false" Inherits="MediaWeb.NewMedia.BaseData.AuditedMediaList" %>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td align="right" style="width: 17%" class="tablehead">
                                        ...
                                        &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" class="bigfont" Text="添加新媒体"
