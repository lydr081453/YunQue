<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebMediaAddAndEdit.ascx.cs" Inherits="MediaWeb.NewMedia.BaseData.skins.WebMediaAddAndEdit" %>
...
//            ESP.MediaLinq.BusinessLogic.MediaItemManager.GetChannelNameByCnName($("#<%=txtWebName.ClientID %>").val(),popchan);
//            function popchan(cr)
//            {
