<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DABMediaAddAndEdit.ascx.cs" Inherits="MediaWeb.NewMedia.BaseData.skins.DABMediaAddAndEdit" %>
...
//            ESP.MediaLinq.BusinessLogic.MediaItemManager.GetChannelNameByCnName($("#<%=txtDABName.ClientID %>").val(), popchan);
//            function popchan(cr) {
...
//            ESP.MediaLinq.BusinessLogic.MediaItemManager.GetTopicNameByCnName($("#<%=txtDABName.ClientID %>").val(), $("#<%=txtDABChannelName.ClientID %>").val(), poptopic);
