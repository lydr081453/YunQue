<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediaList.aspx.cs" Inherits="MediaWeb.NewMedia.BaseData.MediaList" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="server">
        ...
        <ContentTemplate>
            <table width="100%">
                <tr>
                    ...
                    <td width="35%">
                        <div style="margin-bottom: 15px;">
                            <ComponentArt:ComboBox ID="ddlMediaType" runat="Server" Width="192" Height="20" AutoHighlight="false"
                ...
                <tr>
                    ...
                    <td width="35%">
                        <div style="margin-bottom: 15px;">
                            <ComponentArt:ComboBox ID="ddl" runat="Server" Width="192" Height="20" AutoHighlight="false"
                    ...
                    <td width="35%">
                        <div style="margin-bottom: 15px;">
                            <ComponentArt:ComboBox ID="ddlIndustries" runat="Server" Width="192" Height="20" AutoHighlight="false"
                                AutoComplete="true" AutoFilter="true" DataTextField="CountryName" DataValueField="CountryID"
                                TextBoxCssClass="txt" DropHoverImageUrl="../images/ddn-hover.png" DropImageUrl="../images/ddn.png"
                                DropDownResizingMode="bottom" DropDownWidth="190" DropDownHeight="300" DropDownCssClass="ddn"
                                DropDownContentCssClass="ddn-con">
    ...
    <br />
    <ComponentArt:Grid ID="grdMedia" PreHeaderClientTemplateId="PreHeaderTemplate" OnItemCommand="grdMedia_ItemCommond"
