<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeBehind="ReporterList.aspx.cs" Inherits="MediaWeb.NewMedia.BaseData.ReporterList" %>
...
//            }
       ...
       function   WinOpen()   
      {   
      window.open("ReporterSelectMedia.aspx","选择媒体","<%= ESP.MediaLinq.Utilities.Global.OpenClass.Common%>");    
      }
        ...
        <tr>
            <td width="100%">
                <table width="100%" border="0">
                    <tr>
                        <td class="headinglist" align="left" width="30%">
                            记者列表
                        </td>
