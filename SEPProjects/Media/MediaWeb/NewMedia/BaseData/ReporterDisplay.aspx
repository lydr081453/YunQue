<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeBehind="ReporterDisplay.aspx.cs" Inherits="MediaWeb.NewMedia.BaseData.ReporterDisplay" %>
...
<asp:Content ID="cntHead" ContentPlaceHolderID="contentHead" runat="server">
    ...
    function   WinOpen()   
      ...
      window.open("ReporterViewMediaDisplay.aspx?Mid="+Mid.value +"&Rid="+Rid.value,"媒体详细信息","<%= ESP.MediaLinq.Utilities.Global.OpenClass.Common%>");    
      } 
    ...
    <table style="width: 100%" border="1" class="tableForm">
        ...
        <tr >
            ...
            <td class="oddrow-l" colspan="3">
                <asp:LinkButton ID="lnkAgencyName" runat="server" />                
