<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="MediaDisplay.aspx.cs" Inherits="MediaWeb.NewMedia.BaseData.MediaDisplay" %>

<%@ Register TagPrefix="cc4" Namespace="MyControls.GridView" Assembly="MyControls" %>
<%@ Register TagPrefix="uc" TagName="DABMediaDisplay" Src="~/NewMedia/BaseData/skins/DABMediaDisplay.ascx" %>
<%@ Register TagPrefix="uc" TagName="PlaneMediaDisplay" Src="~/NewMedia/BaseData/skins/PlaneMediaDisplay.ascx" %>
<%@ Register TagPrefix="uc" TagName="TvMediaDisplay" Src="~/NewMedia/BaseData/skins/TvMediaDisplay.ascx" %>
<%@ Register TagPrefix="uc" TagName="WebMediaDisplay" Src="~/NewMedia/BaseData/skins/WebMediaDisplay.ascx" %>
