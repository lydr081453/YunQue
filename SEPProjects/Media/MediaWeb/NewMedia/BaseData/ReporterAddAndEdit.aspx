<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporterAddAndEdit.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="MediaWeb.NewMedia.BaseData.ReporterAddAndEdit" %>
...
<%@ Register TagPrefix="uc" TagName="Experience" Src="skins/Experience.ascx" %>
...
//            }
        ...
        function openSelectAgency() {
            var rid = document.getElementById("<%= hidRid.ClientID %>").value;
            var mid = document.getElementById("<%= hidMedia.ClientID %>").value;
            window.open("ReporterSelectAgencyList.aspx?alert=1&Rid=" + rid + "&Mid=" + mid + "&Operate=New", '关联所属机构', '<%= ESP.Media.Access.Utilities.Global.OpenClass.Common %>');
            return false;
        }
    </script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentMain" runat="Server">
    <table style="width: 100%" border="1" class="tableForm">
        ...
        <tr >
            ...
            <td class="oddrow-l" colspan="3">
                <asp:TextBox ID="txtAgencyName" runat="server" Enabled="false" />                
                <asp:HiddenField ID="hidAgency" Value="0" runat="server" />
                &nbsp;<asp:Button ID="btnAgencyLink" runat="server" OnClick="btnAgencyLink_Click" Text="变更所属机构"
                    CssClass="bigwidebuttons" />
            </td>
        </tr>        
        <tr>
    ...
    <table style="width: 100%;" border="1" class="tableForm" id="tbPrivacy" visible="false"
        ...
        <tr>
            ...
            <td class="oddrow-l">
                <asp:TextBox ID="txtTel" runat="server" MaxLength="12" />
            </td>
            <td class="oddrow">
                收款人手机：
            </td>
            <td class="oddrow-l">
                <asp:TextBox ID="txtMobile" runat="server" MaxLength="12" />
            </td>
        </tr>        
        <tr>
            <td class="oddrow">
