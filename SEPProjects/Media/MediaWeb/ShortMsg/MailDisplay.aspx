<%@ Page Language="C#" AutoEventWireup="true" Inherits="ShortMsg_MailDisplay"
    MasterPageFile="~/MasterPage.master" Codebehind="MailDisplay.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentMain" runat="Server">
    <table style="width: 100%;" border="1" class="tableForm">
        ...
        <tr>
            ...
            <td colspan="3" class="oddrow-l">
                <asp:Label ID="labAnnx" runat="server"></asp:Label>
            </td>
        </tr>
        </table>
