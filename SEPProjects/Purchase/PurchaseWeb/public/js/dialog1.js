...
function dialog(title, content, width, height, cssName) {
    ...
    if (dialogFirst == true) {
        ...
        temp_float += "<div id=\"floatBox\" class=\"floatBox2\" style=\"position:absolute;z-index:999999;overflow:hidden\">";
        temp_float += "<div class=\"title\" ><h4></h4><span onclick=\"hidselect();\">关闭</span></div>";
