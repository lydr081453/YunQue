<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Inherits="PRMedia_PRMediaList" Codebehind="PRMediaList.aspx.cs" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <cc2:NewGridView ID="gvG" runat="server"  AutoGenerateColumns="False"
                                DataKeyNames="id" PageSize="20" Width="100%" AllowPaging="True" PagerSettings-Position="Bottom"
                               ...
                               <%--     <asp:TemplateField HeaderText="分公司审核人" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="6%" >
                                    ...
                                    <asp:TemplateField HeaderText="处理" ItemStyle-Width="4%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                        <a href='PRMediaOrderList.aspx?<% =RequestName.GeneralID %>=<%#DataBinder.Eval(Container.DataItem,"id")%>'>
                                    ...
                                    <asp:TemplateField HeaderText="查看" ItemStyle-Width="4%" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <a href="/Purchase/Requisition/OrderDetail.aspx?backUrl=/PRMedia/PRMediaList.aspx&<%#RequestName.GeneralID %>=<%#Eval("id") %>&<%#RequestName.ProjectID %>=<%#Eval("projectid") %>">
