...
CodeBehind="SupplyAndESPTypeInfo.aspx.cs" Inherits="SupplyAndESPTypeInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="/public/js/jquery.js" type="text/javascript"></script>
    <script type="text/javascript" src="/public/js/dialog.js"></script>
<script type="text/javascript">
    function btnTypeClick1() {
        window.location.href = "SupplyAndESPTypeInfo.aspx?tid=0";
    }
    ...
    function selectType(keys) {
        if (keys == "") {
            dialog("选择关联的采购物料", "iframe:SelectTypeESP.aspx", "400px", "600px", "text");
        }
    }
</script>
    <style type="text/css">
...
<table><tr>
        ...
        <asp:HyperLink ID="lbesp" runat="server"  Text="采购系统" NavigateUrl="ESPAndSupplyTypeInfo.aspx?tid=0" ForeColor="Black"  />
        </td>
        <td class="tdTag1" align="center">
        <asp:HyperLink ID="lbsupply" runat="server" Text="供应链" NavigateUrl="SupplyAndESPTypeInfo.aspx?tid=0"  ForeColor="White"/>
        </td>
</tr>
            <tr>
            ...
            <tr>
                <td valign="top">
                    <div style="position: relative; vertical-align: top; padding-left: 10px;
                        height: 100%">
                        <span id="Span1" runat="server" onclick="btnTypeClick1();" style="cursor:pointer" >物料类别</span>
                ...
                <td colspan="4">
                    <table id="tab1" width="100%" border="0" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="oddrow" style="width: 20%" runat="server" id="tdAuditor" visible="false">
                                初审人：
                            </td>
                            <td class="oddrow-l" style="width: 30%" runat="server" id="tdAuditor0" visible="false">
                                ...
                                <asp:Button ID="btnSelect" OnClientClick="EmplyeeClick('producttype1');return false;"
                                    CssClass="widebuttons" runat="server" Text="选择" Visible="false" />
                        ...
                        <tr  runat="server" id="trSaG0" visible="false">
                            <td class="oddrow" style="width: 20%">
                                上海分公司审核人：
                            </td>
                            <td class="oddrow-l" style="width: 30%">
                                <asp:TextBox ID="txtSHAuditor" runat="server" Enabled="false" />
                                <font color="red"><asp:Label ID="Label4" runat="server"> * </asp:Label></font>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="请选择上海分公司审核人"
                                    Display="None" ControlToValidate="txtSHAuditor" ValidationGroup="g1"></asp:RequiredFieldValidator>
                            </td>
                            <td class="oddrow" style="width: 20%">
                                广州分公司审核人：
                            </td>
                            <td class="oddrow-l" style="width: 30%">
                                ...
                                <font color="red"><asp:Label ID="Label5" runat="server"> * </asp:Label></font>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="请选择广州分公司审核人"
                                    Display="None" ControlToValidate="txtGZAuditor" ValidationGroup="g1"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                ...
                <td colspan="4">
                    <table id="tab2" width="100%" border="0" runat="server">
                            ...
                            <tr>
                                ...
                                <td class="oddrow" style="width: 20%" runat="server" id="tdAuditor1" visible="false">
                                    初审人：
                                </td>
                                <td class="oddrow-l" style="width: 30%" runat="server" id="tdAuditor2" visible="false">
                            ...
                            <tr runat="server" id="trSaG" visible="false">
                                <td class="oddrow" style="width: 20%">
                                    上海分公司审核人：
                                </td>
                                <td class="oddrow-l" style="width: 30%">
                                    <asp:TextBox ID="txtSHAuditor1" runat="server" Enabled="false" />
                                    <font color="red"><asp:Label ID="Label2" runat="server"> * </asp:Label></font>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="请选择上海分公司审核人"
                                        Display="None" ControlToValidate="txtSHAuditor1" ValidationGroup="g2"></asp:RequiredFieldValidator>
                                </td>
                                <td class="oddrow" style="width: 20%">
                                    广州分公司审核人：
                                </td>
                                <td class="oddrow-l" style="width: 30%">
                                    ...
                                    <font color="red"><asp:Label ID="Label3" runat="server"> * </asp:Label></font>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="请选择广州分公司审核人"
                                        Display="None" ControlToValidate="txtGZAuditor1" ValidationGroup="g2"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                            <td colspan="4" class="oddrow-l">
                                <asp:GridView ID="gvItems" runat="server" AutoGenerateColumns="false" AllowPaging="false"
                                    OnRowDataBound="Items_RowDataBound" OnRowCommand="Items_RowCommand" DataKeyNames="id">
                                    <Columns>
                                        <asp:TemplateField HeaderText="物料类别名称">
                                                <ItemTemplate>
                                                    <asp:Literal ID="litSupplyTypeName" runat="server" />
                                                </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="采购初审人">
                                            <ItemTemplate>
                                               <asp:Literal ID="litauditorid" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="业务初审人">
                                            <ItemTemplate>
                                                <asp:Literal ID="litoperationflow" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                ...
                <td colspan="4">
                    <table id="tab5" width="100%" border="0" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="oddrow-l" style="width: 30%">
                                <asp:TextBox ID="txtSupplyTypeName" runat="server" Enabled="false" />
                            </td>
                            <td class="oddrow" style="width: 20%">
                                采购物料类别名称：
                            </td>
                            <td class="oddrow-l" style="width: 30%">
                                ...
                                <asp:HiddenField ID="hidESPTypeid" runat="server" />
