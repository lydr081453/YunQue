<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="SelectTypeESP.aspx.cs" 
Inherits="SelectTypeESP" %>
            ...
            <tr>
                <td valign="top">
                    <div style="position: relative; vertical-align: top; padding-left: 20px;
                        height: 100%">
                        <span id="Span0" runat="server" style="cursor:pointer" >物料类别</span>
                        <yyc:SmartTreeView ID="stv0" runat="server" AllowCascadeCheckbox="True" ImageSet="Msdn" ShowLines="true"
                            NodeIndent="20" OnSelectedNodeChanged="stv0_SelectedNodeChanged">
