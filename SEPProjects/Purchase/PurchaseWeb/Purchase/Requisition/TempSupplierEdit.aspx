<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="TempSupplierEdit.aspx.cs" Inherits="PurchaseWeb.Purchase.Requisition.TempSupplierEdit" %>
            ...
            <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="AjaxTabStrip" Width="98%">
                <cc1:TabPanel ID="TabPanel1" HeaderText="基础信息" runat="server">
                    <ContentTemplate>
                        <table width="100%" class="tableForm">
                            <tr>
                                <td class="heading" colspan="4">临时供应商信息编辑
                                </td>
                            </tr>
                            <tr>
        ...
        <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvProduct_RowDeleting"
            ...
            <asp:TemplateField HeaderText="选择" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="5%">
                ...
                <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <a href="ProductView.aspx?backUrl=TempSupplierEdit.aspx&productId=<%#Eval("id") %>&sid=<%#Eval("supplierId") %>">
                ...
                <asp:TemplateField HeaderText="编辑">
                    ...
                    <ItemTemplate>
                        <a href='ProductEdit.aspx?backUrl=TempSupplierEdit.aspx&productId=<%#DataBinder.Eval(Container.DataItem,"id")%>&sid=<%#Eval("supplierId") %>'>
