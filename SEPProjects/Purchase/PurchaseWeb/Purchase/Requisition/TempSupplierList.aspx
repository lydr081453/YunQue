<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="TempSupplierList.aspx.cs" Inherits="PurchaseWeb.Purchase.Requisition.TempSupplierList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function openwindow(id) {
            window.open("TempSupplierView.aspx?supplierId=" + id);
        }
    ...
    <cc2:NewGridView ID="gvSupplier" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvSupplier_RowDeleting"
        ...
        <Columns>
            <asp:TemplateField HeaderText="供应商名称" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center" SortExpression="supplier_name">
                <ItemTemplate>
                    <label onclick="openwindow(<%#Eval("id") %>);" style="color:#7282a9;cursor:pointer"><%#Eval("supplier_name")%></label>                        
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="转换" HeaderStyle-Width="4%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" CommandArgument='<%# Eval("id") %>' runat="server"
                        OnClientClick="return confirm('您确定转换为推荐供应商吗？');" Text="<img src='/images/changed.gif' border='0' />"
                        ToolTip="转换为推荐供应商" CommandName="Changed" CausesValidation="false" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="编辑">
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                <ItemTemplate>
                    <a href='TempSupplierEdit.aspx?tsupplierId=<%#DataBinder.Eval(Container.DataItem,"id")%>'>
