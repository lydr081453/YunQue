<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" Inherits="Purchase_Requisition_SupplierInfoEdit"
    Title="Untitled Page" Codebehind="SupplierInfoEdit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <tr>
        <td colspan="4">
            ...
            <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="AjaxTabStrip" Width="98%" ActiveTabIndex="0">
                <cc1:TabPanel ID="TabPanel1" HeaderText="基础信息" runat="server">
                    <ContentTemplate>
                        <table width="100%" class="tableForm">
                            <tr>
                                <td class="heading" colspan="4">供应商信息编辑
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtsupplier_area1" runat="server" MaxLength="100" /></td>
                                <td class="oddrow" style="width: 20%">行业:</td>
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtsupplier_industry" runat="server" MaxLength="100" /></td>
                            </tr>
                            <tr>
                                <td class="oddrow">规模:</td>
                                <td class="oddrow-l"><asp:TextBox ID="txtsupplier_scale" runat="server" MaxLength="100" /></td>
                                <td class="oddrow">注册资本:</td>
                                <td class="oddrow-l"><asp:TextBox ID="txtsupplier_principal" runat="server" MaxLength="50" /></td>
                            </tr>
                            <tr>
                                <td class="oddrow">成立年限:</td>
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtsupplier_builttime" runat="server" MaxLength="50" /></td>
                                <td class="oddrow">网址:</td>
                                <td class="oddrow-l"><asp:TextBox ID="txtsupplier_website" runat="server" MaxLength="100" /></td>
                            </tr>
                            <tr>
                                <td class="oddrow">协议框架号:</td>
                                <td class="oddrow-l"><asp:TextBox ID="txtfa_no" runat="server" MaxLength="50" /></td>
                                                                <td class="oddrow">使用状态:</td>
                                <td class="oddrow-l"><asp:DropDownList ID="ddlStatus" runat="server" /></td>
                            </tr>
                            <tr >
                                                            <td class="oddrow">供应商来源:</td>
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtsupplier_source" runat="server" MaxLength="50" /></td>
                                <td class="oddrow">供应商类型:</td>
                                <td class="oddrow-l"><asp:DropDownList ID="ddlSupplierType" runat="server" /></td>

                            </tr>
                            <tr>
<%--                                                        <td class="oddrow">预估成本比例：</td>
                        <td class="oddrow-l" colspan="3"><asp:TextBox ID="txtCostRate" runat="server"  />%<asp:CompareValidator ID="CompareValidator1" runat="server" Type="Double" Operator="GreaterThanEqual" ValueToCompare="0" ControlToValidate="txtCostRate"
                            ErrorMessage="预估成本比例错误"></asp:CompareValidator></td>
                            </tr>--%>
                        </table>
                    <%--</td>
                </tr>
                            ...
                            <asp:Panel ID="Panel2" runat="server">
                                <table width="100%" class="tableForm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtLinker" runat="server" MaxLength="50"  /></td>
...
<%--                                            <asp:TextBox ID="txtsupplier_con" runat="server" Width="30px" MaxLength="4" /><asp:RegularExpressionValidator
                                            ...
                                            <asp:TextBox ID="txtsupplier_phone" runat="server" /><%--<asp:RegularExpressionValidator
                                    ...
                                    <tr>
                                        ...
                                        <td class="oddrow-l"><asp:TextBox ID="txtCellPhone" runat="server" MaxLength="50" /></td>
                                        <td class="oddrow">Email:</td>
                                        <td class="oddrow-l"><asp:TextBox ID="txtEmail" runat="server" MaxLength="50"  />
...
<%--                                            <asp:TextBox ID="txtsupplierfax_con" runat="server" Width="30px" MaxLength="5"/><asp:RegularExpressionValidator
                                            ...
                                            <asp:TextBox ID="txtsupplierfax_area" runat="server" Width="30px" MaxLength="4"/><asp:RegularExpressionValidator
                                                ID="RegularExpressionValidator14" runat="server" ErrorMessage=" ! " ControlToValidate="txtsupplierfax_area"
                                                 Display="None" ValidationExpression="^\d{2,4}$"></asp:RegularExpressionValidator>---%>
                                            <asp:TextBox ID="txtsupplierfax_phone" runat="server" />
<%--                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" ErrorMessage=" ! " ControlToValidate="txtsupplierfax_phone"  Display="None" ValidationExpression="^\d{6,8}$"></asp:RegularExpressionValidator>-
                                            <asp:TextBox ID="txtsupplierfax_ext" runat="server" Width="30px" MaxLength="4"/>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator19" runat="server" ErrorMessage=" ! " ControlToValidate="txtsupplierfax_ext"  Display="None" ValidationExpression="^\d{2,4}$"></asp:RegularExpressionValidator><br />例:86-010-85078888-0001--%>
                                        </td>
                                        <td class="oddrow">地址:</td>
                                        <td class="oddrow-l"><asp:TextBox ID="txtAddress" runat="server" MaxLength="200"  /><font color="red"> * </font><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAddress"
                    ...
                    <ContentTemplate>
                        ...
                        <table width="100%" class="tableForm">
                            ...
                            <tr>
                                ...
                                <td class="oddrow-l" style="width: 30%"><asp:DropDownList ID="ddlbusiness_paytime" runat="server"></asp:DropDownList>天</td>
                                <td class="oddrow" style="width: 20%">预付款:</td>
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtbusiness_prepay" runat="server" MaxLength="50" /></td>
                            </tr>
                        </table>
                </asp:Panel>
                    </ContentTemplate>
                    ...
                    <ContentTemplate>
                        ...
                        <table width="100%" class="tableForm">
                            ...
                            <tr>
                                ...
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtaccount_name" runat="server" MaxLength="100" /></td>
                                <td class="oddrow" style="width: 20%">开户银行:</td>
                                <td class="oddrow-l" style="width: 30%"><asp:TextBox ID="txtaccount_bank" runat="server" MaxLength="100" /></td>
                            </tr>
                            <tr>
                                <td class="oddrow">帐号:</td>
                                <td class="oddrow-l"><asp:TextBox ID="txtaccount_number" runat="server" MaxLength="100" /></td>
                                <td class="oddrow">&nbsp;</td>
        ...
        <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvProduct_RowDeleting"
            ...
            <asp:TemplateField HeaderText="选择" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="5%">
                ...
                <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <a href="ProductView.aspx?backUrl=SupplierInfoEdit.aspx&productId=<%#Eval("id") %>&sid=<%#Eval("supplierId") %>">
                ...
                <asp:TemplateField HeaderText="编辑">
                    ...
                    <ItemTemplate>
                        <a href='ProductEdit.aspx?backUrl=SupplierInfoEdit.aspx&productId=<%#DataBinder.Eval(Container.DataItem,"id")%>&sid=<%#Eval("supplierId") %>'>
