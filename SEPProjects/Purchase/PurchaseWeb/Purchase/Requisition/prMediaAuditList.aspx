<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Purchase_Requisition_prMediaAuditList" CodeBehind="prMediaAuditList.aspx.cs" %>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?backUrl=prMediaAuditList.aspx&<% = RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("prNO") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="审批" ItemStyle-Width="3%">
                                        ...
                                        <ItemTemplate>
                                            <a href='prMediaAudit.aspx?backUrl=prMediaAuditList.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>'>
