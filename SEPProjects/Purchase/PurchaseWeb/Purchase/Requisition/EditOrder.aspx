<%@ Page Language="C#" AutoEventWireup="true" Inherits="Purchase_Requisition_EditOrder"
    MasterPageFile="~/MasterPage.master" CodeBehind="EditOrder.aspx.cs" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td colspan="2" style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px;
                ...
                <table class="tableForm" id="tabOverrule" width="100%">
                    <tr>
                        ...
                        <td class="oddrow-l" style="width: 85%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtoverrule"
                                ErrorMessage="审核备注为必填" Display="None"></asp:RequiredFieldValidator><font color="red">*</font>
    ...
    <table width="100%">
        <tr>
            <td height="25" colspan="2" align="center">
                <prc:CheckPRInputButton runat="server" ID="btnAdd" value=" 保存 " type="button" onclick="showLoading();"
                    CausesValidation="false" class="widebuttons" OnServerClick="btnAdd_Click" />
                <prc:CheckPRInputButton runat="server" ID="btnCommit" value="审核通过" type="button"
                    onclick="if(confirm('您确定要审核通过吗？')){showLoading();}else{return false;}" CausesValidation="false"
                    class="widebuttons" OnServerClick="btnCommit_Click" />
                <prc:CheckPRInputButton runat="server" ID="btnReturn" value="审核驳回" type="button"
                    onclick="if(confirm('您确定要审核驳回吗？')){showLoading();}else{return false;}"
                    CausesValidation="false" class="widebuttons" OnServerClick="btnReturn_Click" />
                <asp:Button ID="btnCancel" runat="server" Text=" 返回 " CausesValidation="false" PostBackUrl="~/Purchase/Requisition/OrderList.aspx"
