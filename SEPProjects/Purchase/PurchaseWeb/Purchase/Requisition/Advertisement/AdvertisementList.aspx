<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeBehind="AdvertisementList.aspx.cs" Inherits="PurchaseWeb.Purchase.Requisition.Advertisement.AdvertisementList" %>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id" PageSize="20" AllowPaging="True" Width="100%" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="媒体名称" ItemStyle-HorizontalAlign="Center">
                                        <ItemStyle Width="20%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblMediaName" Text='<%# Eval("MediaName") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="媒体类型" ItemStyle-HorizontalAlign="Center">
                                        <ItemStyle Width="20%" />
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="编辑" ItemStyle-HorizontalAlign="Center">
                                        <ItemStyle Width="10%" />
                                        <ItemTemplate>
                                            <a href='AdvertisementEdit.aspx?AdvertisementID=<%# Eval("ID") %> '><img src="../../../images/edit.gif" alt="编辑" style="border:0" /></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
