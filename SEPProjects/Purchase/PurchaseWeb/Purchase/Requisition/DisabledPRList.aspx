<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="DisabledPRList.aspx.cs" Inherits="Purchase_Requisition_DisabledPRList" %>
                                        ...
                                        <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="流水号" ItemStyle-HorizontalAlign="Center"
                                                    ItemStyle-Width="6%">
                                                    <ItemTemplate>
                                                        <a href="ShowRequisitionDetail.aspx?<% =RequestName.GeneralID %>=<%#Eval("id") %>&pageUrl=DisabledPRList.aspx&helpfile=3">
                                                            <%#Eval("glideNo") %></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField HeaderText="申请单号" DataField="prNo" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <asp:TemplateField HeaderText="暂停">
                                                        ...
                                                        <itemtemplate>
                                                        <asp:LinkButton ID="lnkDisabled" runat="server" Font-Underline="true" OnClientClick="return confirm('您确定要暂停该申请单吗？');"
                                                            Text="<img title='暂停' src='../../images/Icon_handconfrim.gif' border='0' />"
                                                            CommandName="Disabled" CommandArgument='<%# Eval("id") %>' />
                                                    </itemtemplate>
                                                    </asp:TemplateField>
                                                                                                        <asp:TemplateField HeaderText="停止">
                                                        <itemstyle horizontalalign="Center"></itemstyle>
                                                        <itemtemplate>
                                                        <asp:LinkButton ID="lnkStop" runat="server" Font-Underline="true" OnClientClick="return confirm('您确定要停止该申请单吗？');"
                                                            Text="<img title='停止' src='../../images/Icon_handconfrim.gif' border='0' />"
                                                            CommandName="Stop" CommandArgument='<%# Eval("id") %>' />
                                                    </itemtemplate>
                                                    </asp:TemplateField>
                                            </Columns>
