<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Purchase_Requisition_prMediaAuditYesList" CodeBehind="prMediaAuditYesList.aspx.cs" %>
                        ...
                        <td colspan="2">
                            <table width="100%" class="tableForm">
                                ...
                                <tr>
                                    ...
                                    <td class="oddrow-l">
                                        <asp:TextBox ID="txtsupplier" MaxLength="200" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?backUrl=prMediaAuditYesList.aspx&<% = ESP.Purchase.Common.RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("prNO") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
