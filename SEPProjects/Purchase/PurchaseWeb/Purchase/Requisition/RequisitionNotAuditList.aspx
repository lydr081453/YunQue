<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"  Inherits="Purchase_Requisition_RequisitionNotAuditList" Codebehind="RequisitionNotAuditList.aspx.cs" %>
                            ...
                            <asp:GridView ID="gvG" runat="server"  AutoGenerateColumns="False" DataKeyNames="id" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?vis=false&<% =RequestName.GeneralID %>=<%#Eval("id") %>&backUrl=RequisitionNotAuditList.aspx&helpfile=3"><%#Eval("prNo") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="申请时间">
                                        <ItemTemplate>
                                            <%# Eval("app_date").ToString() == State.datetime_minvalue ? "" : DateTime.Parse(Eval("app_date").ToString()).ToString("yyyy-MM-dd")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="申请单提交时间">
                                        <ItemTemplate>
                                            <%# Eval("requisition_committime").ToString() == State.datetime_minvalue ? "" : DateTime.Parse(Eval("requisition_committime").ToString()).ToString("yyyy-MM-dd")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?vis=false&helpfile=3&<% =RequestName.GeneralID %>=<%#Eval("id") %>&backUrl=RequisitionNotAuditList.aspx"><img src="../../images/dc.gif" border="0px;"></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>								
