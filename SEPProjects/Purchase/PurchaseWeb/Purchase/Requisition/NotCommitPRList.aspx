<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="NotCommitPRList.aspx.cs" Inherits="Purchase_Requisition_NotCommitPRList" %>
                            ...
                            <table width="100%" class="tableForm" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="oddrow-l" style="width: 35%">
                                        <asp:TextBox ID="txtProjectNo" runat="server" MaxLength="300" />
                                    </td>
                                    <td class="oddrow" style="width: 15%">
                                        申请时间:
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="oddrow-l">
                                        <asp:TextBox ID="txtItemNo" runat="server" MaxLength="300" />
                                    </td>
                                    <td class="oddrow">
                                        采购总金额:
                                    </td>
                                    <td class="oddrow-l">
                                        (Min)<asp:TextBox ID="txtTotalMin" runat="server" MaxLength="300"></asp:TextBox>----<asp:TextBox
                                            ID="txtTotalMax" runat="server" MaxLength="300"></asp:TextBox>(Max)
                                    </td>
                                </tr>
                                <tr>
                                    <td class="oddrow" style="width: 15%">
                                    ...
                                    <td class="oddrow-l">
                                        <asp:TextBox ID="txtRequestor" runat="server" MaxLength="50" />
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                                PageSize="20" Width="100%" AllowPaging="True" OnRowDataBound="gvG_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="查看">
                                        ...
                                        <ItemTemplate>
                                            <a href="ShowRequisitionDetail.aspx?pageUrl=NotCommitPRList.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>">
