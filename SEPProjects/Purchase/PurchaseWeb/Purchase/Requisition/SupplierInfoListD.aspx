<%@ Page Title="协议供应商列表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Purchase_Requisition_SupplierInfoListD" Codebehind="SupplierInfoListD.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style=" text-align:right"><asp:Button ID="btnPrint" runat="server" Text="打印供应商" CssClass="widebuttons" onClientClick="printSupplier();return false;" /></td>
        </tr>
    </table>
    <br />
    <cc2:NewGridView ID="gvSupplier" runat="server" AutoGenerateColumns="False" AllowSorting="true"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="supplier_frameNO" ItemStyle-HorizontalAlign="Center" HeaderText="框架协议号" />
    ...
    <br />
    <asp:Button ID="txtBack" runat="server" Text=" 返回 " CssClass="widebuttons" OnClick="btnBack_Click" />
