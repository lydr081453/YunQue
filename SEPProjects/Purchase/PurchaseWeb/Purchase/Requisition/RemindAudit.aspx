<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true"
    CodeBehind="RemindAudit.aspx.cs" Inherits="PurchaseWeb.Purchase.Requisition.RemindAudit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" class="tableForm">
        <tr class="heading">
            <td>
                <font style="font-size:15px"><asp:Literal ID="litTitle" runat="server" Text="付款申请延迟信息" /></font>
            </td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="gvList" runat="server" AllowPaging="false" Width="100%" AutoGenerateColumns="false">
                    <Columns>
                        <asp:BoundField HeaderText="发送人" ItemStyle-HorizontalAlign="center" DataField="SenderName" />
                        <asp:BoundField HeaderText="发送时间" ItemStyle-HorizontalAlign="center" DataField="SendMailTime" />
                        <asp:BoundField HeaderText="反馈时间" ItemStyle-HorizontalAlign="center" DataField="ResponseTime" />
                        <asp:BoundField HeaderText="反馈内容" ItemStyle-HorizontalAlign="center" DataField="ResponseContent" />
                    </Columns>
                </asp:GridView>
            </td>
        </tr>
