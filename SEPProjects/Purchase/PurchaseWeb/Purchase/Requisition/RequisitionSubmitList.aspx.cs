...
public partial class Purchase_Requisition_RequisitionSubmitList : ESP.Web.UI.PageBase
{
    ...
    protected void gvG_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            repProduct.DataSource = OrderInfoManager.GetListByGeneralId(((GeneralInfo)e.Row.DataItem).id);
            repProduct.DataBind();
        }
    }
