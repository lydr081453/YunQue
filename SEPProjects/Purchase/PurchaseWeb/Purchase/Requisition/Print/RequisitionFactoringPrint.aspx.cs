...
{
    public partial class RequisitionFactoringPrint : ESP.Web.UI.PageBase
    {
        ...
        protected void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ESP.Finance.Entity.BankInfo bankModel = ESP.Finance.BusinessLogic.BankManager.GetModel(generalInfo.IsFactoring);
                ...
                {
                    strlog += log.Des.Replace(generalInfo.supplier_name,bankModel.BankAccountName) + "<br/>";
                }
                ...
                if (generalInfo.IsFactoring > 0)
                {
                    
                    lab_supplier_name.Text = bankModel.BankAccountName;
                    lab_supplier_address.Text = bankModel.Address;
                    lab_supplier_linkman.Text = bankModel.DBManager;
                    lab_supplier_phone.Text = bankModel.RequestPhone;
                    lab_supplier_fax.Text = "";
                    lab_supplier_email.Text = bankModel.ExchangeNo;
