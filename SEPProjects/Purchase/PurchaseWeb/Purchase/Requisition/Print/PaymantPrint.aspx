<%@ Page Language="C#" AutoEventWireup="true" Inherits="Purchase_Requisition_Print_PaymantPrint" Codebehind="PaymantPrint.aspx.cs" %>
...
<form id="form1" runat="server">
    ...
    <table width="620px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
    <td colspan="3" height="40" valign="bottom" style="padding:0 0 5px 0"><asp:Image  runat="server" id="logoImg" width="126" height="70"  /></td>
    <td align="center" colspan="5" valign="middle" style="padding:0 0 5px 0;font-size:24px;"><asp:Label runat="server" ID="lblTitle"></asp:Label></td>
    
  </tr>

  <tr>
  <td align="left" colspan="2"><span style="color:Black;font-size:12px;" >申请单号:</span>&nbsp;<asp:Label runat="server" style="color:red;font-size:12px;" ID="lblPN"/>&nbsp;</td>
  <td align="left" colspan="2"></td>
  <td align="Right" colspan="2"><span style="color:Black;font-size:12px;" >PR单号:</span></td>
  <td align="Left" colspan="2"><asp:Label runat="server" style="color:red;font-size:12px;" ID="lblPRNo" />&nbsp;</td>
  </tr>
    <tr>
  <td align="left" colspan="2"><span style="color:Black;font-size:12px;" >预计付款日期:</span>&nbsp;<asp:Label runat="server" style="color:red;font-size:12px;" ID="lblPreDate"/>&nbsp;</td>
  <td align="left" colspan="2"></td>
  <td align="Right" colspan="2"><span style="color:Black;font-size:12px;" >提交日期:</span></td>
  <td align="Left" colspan="2"><asp:Label runat="server" style="color:red;font-size:12px;" ID="lblCommitDate" />&nbsp;</td>
  </tr>
  
  <tr>
    <td width="110px" height="20" align="center" class="test_title_right" style=" font-size:12px;">项目号</td>
    <td width="90px" align="center" class="test_title_right" style=" font-size:12px;">费用发生日期</td>
    <td width="50px" align="center" class="test_title_right" style=" font-size:12px;">申请人</td>
    <td width="60px" align="center" class="test_title_right" style=" font-size:12px;">员工编号</td>
    <td width="50px" align="center" class="test_title_right" style=" font-size:12px;">费用所属组</td>
    <td width="150px" align="center" class="test_title_right" style=" font-size:12px;">费用明细描述</td>
    <td width="50px" align="center" class="test_title_right" style=" font-size:12px;">申请金额</td>
    <td width="60px" align="center" class="test_title_right" style=" font-size:12px;">订单号</td>
  </tr>  
  <tr>
        ...
        <td align="left" class="f12pxGgray" style=" font-size:12px;"><asp:Label ID="labReturnContent" runat="server" />&nbsp;</td>
        <td align="right" class="f12pxGgray" style=" font-size:12px;"><asp:Label ID="labPreFee" runat="server" />&nbsp;</td>
        <td align="center" class="f12pxGgray_right" style=" font-size:12px;"><asp:Label ID="labOrderid" runat="server" />&nbsp;</td>
      </tr>
  <tr>
  ...
  <tr>
     <td  class="f12pxGgray">&nbsp;</td>
     <td  class="f12pxGgray">&nbsp;</td>
     <td align="center"  colspan="3" height="20" class="f12pxGgrayBold" style=" font-size:12px;">公司名称</td>
  ...
  <tr>
     <td  class="f12pxGgray">&nbsp;</td>
     <td  class="f12pxGgray">&nbsp;</td>
     <td align="center"  colspan="3" height="20" class="f12pxGgrayBold" style=" font-size:12px;">开户行名称</td>
  ...
  <tr>
     <td  class="f12pxGgray">&nbsp;</td>
     <td  class="f12pxGgray">&nbsp;</td>
     <td align="center"  colspan="3" height="20" class="f12pxGgrayBold" style=" font-size:12px;">银行帐号</td>
     ...
     <td class="f12pxGgray_right" align="left" colspan="7" ><asp:Label ID="lblRemark" runat="server" />&nbsp;</td>
  </tr>
     <tr>
     <td  align="center" height="20" class="f12pxGgrayBold" style=" font-size:12px;">&nbsp;</td>
     <td class="f12pxGgray_right" align="left" colspan="7" style=" font-size:12px; font-weight:bolder;"><asp:Label ID="lblTaxDesc" runat="server" />&nbsp;</td>
  </tr>
  <tr>
  <td height="10"></td>
  </tr>
...
<table width="620px" border="0" align="center" cellpadding="0" cellspacing="0">
