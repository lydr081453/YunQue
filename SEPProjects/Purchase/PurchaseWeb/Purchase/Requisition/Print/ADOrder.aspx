<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADOrder.aspx.cs" Inherits="PurchaseWeb.Purchase.Requisition.Print.ADOrder" %>
<%@ Import Namespace="ESP.Purchase.Common" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    <title>媒介采购申请单PR</title>
...
<body>
    ...
    <table width="630" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <asp:Repeater ID="repItem" runat="server" OnItemDataBound="repItem_ItemDataBound">
            <ItemTemplate>
                ...
                <tr>
                    <td width="30" rowspan="4" height="80px" align="center" class="f12pxGgray">
                        <asp:Label ID="labNum" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td height="20px" align="center" class="f12pxGgray">
                        <strong>广告媒体名称</strong>
                    </td>
                    ...
                    <td align="center" class="f12pxGgray">
                        <strong>广告媒体类型</strong>
                    </td>
                    <td colspan="3" align="center" class="f12pxGgray_right">
                        <asp:Label runat="server" ID="lblTitle" Text='<%#Eval("MediaType") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td height="20px" align="center" class="f12pxGgray">
                    ...
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblReceiptName" Text='<%# Eval("AdvertisementExemplar")%> '></asp:Label>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>刊例总价</strong>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblIDCard" Text='<%#Eval("PriceTotal","{0:#,##0.00}") %> '></asp:Label>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>折扣(Off)</strong>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblDiscount" Text='<%#Eval("Discount") %> ' ></asp:Label>% Off
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>折扣后总价</strong>
                    </td>
                    <td align="right" class="f12pxGgray_right">
                        <asp:Label runat="server" ID="lblAmount" Text='<%#Eval("Total","{0:#,##0.00}") %> '></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td height="20px" align="center" class="f12pxGgray">
                    ...
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblBank" Text='<%#Eval( "DistributionPercent") %> '></asp:Label>%
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>配送总价</strong>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblBankCount" Text='<%#Eval("DistributionPrice","{0:#,##0.00}") %> '></asp:Label>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>返点</strong>
                    </td>
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblCity" Text='<%#Eval("ReturnPoint")   %> '></asp:Label>%
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>账期</strong>
                    </td>
                    <td align="right" class="f12pxGgray_right">
                        单月<asp:Label runat="server" ID="lblDelegate" Text='<%#Eval("AccountPeriod") %>'></asp:Label>天
                    </td>
                </tr>
    ...
    <table width="630px" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
             <td  width="630px" align="right" class="f12pxGgray_Total" style="font-size: 12px; color:Black;
                font-weight: bold">
    ...
    <asp:Repeater ID="repPeriod" runat="server" OnItemDataBound="repPeriod_ItemDataBound">
            <ItemTemplate>
                <tr>
                  <td align="left" width="630px" colspan="6" class="f12pxGgrayNew2" style="font-weight:bold;font-size: 12px;">
                   #<asp:Label ID="labNum" runat="server" />&nbsp;
                  </td>
                  </tr>
                  <tr>
                ...
                <tr>
                 ...
                 <tr>
                   <td colspan="6" width="630px" class="f12pxGgrayNew2">&nbsp;</td>
                 </tr>
                  <tr>
                       <td align="left" width="300px" colspan="3" class="f12pxGgray_Bottom_left_New" style="font-size: 12px; "></td>
                       <td align="left" width="330px" colspan="3" class="f12pxGgray_Bottom_left_New" style="font-size: 12px; "></td>         
                       </tr>
            </ItemTemplate>
        </asp:Repeater>
    ...
    <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="left" height="20px" width="100px" colspan="2" class="f12pxGgrayNew"
            ...
            <td align="left" height="20px" width="100px" colspan="2"
                style="font-size: 12px; font-weight: bold">
                申请单号码
            </td>
    ...
    <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td width="230px" align="left" style="font-size: 12px;border-Bottom-width: 1px;border-Bottom-style: solid;border-Bottom-color: #a5c2a5;">
               &nbsp;
            </td>
