...
public partial class Purchase_Requisition_Print_MultiRecipientPrint : ESP.Web.UI.PageBase
{
    string id = "";
    int num = 1;
    string moneytype = "";
    ...
    protected void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            ESP.Finance.Entity.BranchInfo branchModel = ESP.Finance.BusinessLogic.BranchManager.GetModelByCode(drv.Row["project_code"].ToString().Substring(0, 1));
