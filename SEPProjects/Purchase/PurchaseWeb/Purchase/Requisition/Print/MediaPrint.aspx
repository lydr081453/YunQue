<%@ Page Language="C#" AutoEventWireup="true" Inherits="Purchase_Requisition_Print_MediaPrint"
    CodeBehind="MediaPrint.aspx.cs" %>
...
<body>
    ...
    <table width="620" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
            <td width="155" height="20" align="center" class="f12pxGgrayBold">
                申请日期
            </td>
            <td width="155" align="center" class="f12pxGgrayBold">
                申请人
            </td>
            <td width="155" align="center" class="f12pxGgrayBold">
                申请人组别
            </td>
            <td width="155" align="center" class="f12pxGgray_right">
                <strong>联系方式</strong>
            </td>
        </tr>
        <tr>
    ...
    <table width="620" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
            <td width="620" colspan="6" height="80" align="left" class="f12pxGgray_right">
