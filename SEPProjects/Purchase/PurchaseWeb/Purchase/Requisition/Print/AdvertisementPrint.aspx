<%@ Page Language="C#" AutoEventWireup="true" Inherits="AdvertisementPrint"
    CodeBehind="AdvertisementPrint.aspx.cs" %>
        ...
        <asp:Repeater ID="repItem" runat="server" OnItemDataBound="repItem_ItemDataBound">
            <ItemTemplate>
                ...
                <tr>
                    ...
                    <td align="center" class="f12pxGgray">
                        <asp:Label runat="server" ID="lblReleaseDate" Text='<%#Eval("Discount") %> ' ></asp:Label>%
                    </td>
                    <td align="center" class="f12pxGgray">
                        <strong>总净价</strong>
                    </td>
