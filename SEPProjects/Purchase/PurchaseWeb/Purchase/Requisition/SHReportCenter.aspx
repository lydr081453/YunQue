<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Purchase_Requisition_SHReportCenter" Codebehind="SHReportCenter.aspx.cs" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <table width="100%" class="tableForm">
                                ...
                                <tr>
                                    <td class="oddrow" style="width:15%">供应商名称:</td>
                                    <td class="oddrow-l" style="width:35%"><asp:TextBox ID="txtSupplierName" MaxLength="200" runat="server" /></td>
                                    <td class="oddrow" style="width:15%">物料类别:</td>
                                    <td class="oddrow-l" style="width:35%"><asp:TextBox ID="txtProductType" MaxLength="200" runat="server" /></td>
                                </tr>
                                <tr>
                                    <td class="oddrow" style="width:15%">流水号:</td>
                                    <td class="oddrow-l" style="width:35%"><asp:TextBox ID="txtID" MaxLength="200" runat="server" /></td>
                                    <td class="oddrow" style="width:15%">申请单号:</td>
                                    <td class="oddrow-l" style="width:35%"><asp:TextBox ID="txtPr" MaxLength="200" runat="server" /></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False"
                                PageSize="20" AllowPaging="True" Width="100%"  DataKeyNames="id,moneytype"  OnRowDataBound="gvG_RowDataBound"
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDailyPurchase" runat="server" Text="日常采购数据报表" CssClass="widebuttons" OnClick="btnDailyPurchase_Click" />
                                        &nbsp;<asp:Button ID="btnCusAsk" runat="server" Text="客户指定供应商报告" CssClass="widebuttons" OnClick="btnCusAsk_Click" />
                                        &nbsp;<asp:Button ID="btnAfterwards" runat="server" Text="事后申请报告" CssClass="widebuttons" OnClick="btnAfterwards_Click" />
                                        &nbsp;<asp:Button ID="btnEmBuy" runat="server" Text="特殊采购申请报告" CssClass="widebuttons" OnClick="btnEmBuy_Click" />
                                        &nbsp;<asp:Button ID="btnCostReprot" runat="server" Text="成本分析报告" CssClass="widebuttons" OnClick="btnCostReport_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
