<%@ Page Language="C#" AutoEventWireup="true" Inherits="Purchase_Requisition_OrderList"
    MasterPageFile="~/MasterPage.master" EnableEventValidation="false" CodeBehind="OrderList.aspx.cs" %>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?<% =RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("prNO") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="审核" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%">
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <a href='EditOrder.aspx?<% =RequestName.GeneralID %>=<%#DataBinder.Eval(Container.DataItem,"id")%>'>
                                                <%# int.Parse(Eval("InUse").ToString()) != (int)ESP.Purchase.Common.State.PRInUse.Use ? "" : "<img src='../../images/audit_icon.gif' border='0px;' title='编辑'>"  %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="打印" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%">
                                        ...
                                        <ItemTemplate>
                                            <a href='Print/RequisitionPrint.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>'
                                                target="_blank">
                                                <img title="打印申请单" src="../../images/Icon_PrintPr.gif" border="0px;" /></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
