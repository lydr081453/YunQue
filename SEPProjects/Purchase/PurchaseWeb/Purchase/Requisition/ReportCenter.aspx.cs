...
public partial class Purchase_Requisition_ReportCenter : ESP.Web.UI.PageBase
{
    ...
    private void ListBind()
    {
        ...
        string department = GetLevel1DeparmentID(int.Parse(CurrentUser.SysID));
        if (department == State.filialeName_CQ)
        {
            strWhere += " and  Filiale_Auditor in (" + TypeManager.getSHAuditor() + ")";
        }
        else
        {
            strWhere += " and  Filiale_Auditor=0";
        }
