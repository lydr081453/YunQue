<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Purchase_FilialeAuditList" EnableEventValidation="false" CodeBehind="FilialeAuditList.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function removefocus() {
            document.getElementById("<%=SearchBtn.ClientID %>").focus();
        }
    </script>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                PageSize="20" Width="100%" AllowPaging="True" OnRowCommand="gvG_RowCommand" OnRowDataBound="gvG_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="ShowRequisitionDetail.aspx?pageUrl=FilialeAuditList.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("prNO") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="审核" ItemStyle-Width="3%">
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <a href='Filiale_RequisitionEdit.aspx?<% =RequestName.GeneralID %>=<%#DataBinder.Eval(Container.DataItem,"id")%>'>
                                                <%# int.Parse(Eval("InUse").ToString()) != (int)ESP.Purchase.Common.State.PRInUse.Use ? "" : "<img src='../../images/audit_icon.gif' border='0px;' title='审核'>"%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
