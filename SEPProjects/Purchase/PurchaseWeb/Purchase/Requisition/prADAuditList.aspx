<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="prADAuditList.aspx.cs" Inherits="prADAuditList" %>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="ShowRequisitionDetail.aspx?pageUrl=prADAuditList.aspx&<% = RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("prNO") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="审批" ItemStyle-Width="3%">
                                        ...
                                        <ItemTemplate>
                                            <a href='prADAudit.aspx?backUrl=prADAuditList.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>'>
