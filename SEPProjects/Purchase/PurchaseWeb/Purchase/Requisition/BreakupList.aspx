<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Purchase_Requisition_BreakupList" CodeBehind="BreakupList.aspx.cs" %>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="订单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="BreakupDetail.aspx?backUrl=BreakupList.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("orderid") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="查看" ItemStyle-Width="3%">
                                        ...
                                        <ItemTemplate>
                                            <a href="BreakupDetail.aspx?backUrl=BreakupList.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>&helpfile=3">
