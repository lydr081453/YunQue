<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Purchase_Requisition_RequisitionSubmitList" EnableEventValidation="false" Codebehind="RequisitionSubmitList.aspx.cs" %>
                            ...
                            <asp:GridView ID="gvG" runat="server"  AutoGenerateColumns="False" DataKeyNames="id" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?type=auditR&<% =RequestName.GeneralID %>=<%#Eval("id") %>&backUrl=RequisitionSubmitList.aspx&helpfile=4"><%#Eval("prNo") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="采购物品">
                                        <ItemTemplate>
                                            <asp:Repeater ID="repProduct" runat="server">
                                                <ItemTemplate>
                                                    <%# Eval("Item_No").ToString() + ":" %><%# decimal.Parse(Eval("total").ToString()).ToString("#,##0.####")%><br />
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?type=auditR&<% =RequestName.GeneralID %>=<%#Eval("id") %>&backUrl=RequisitionSubmitList.aspx&helpfile=4"><img src="../../images/dc.gif" border="0px;"></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>									
