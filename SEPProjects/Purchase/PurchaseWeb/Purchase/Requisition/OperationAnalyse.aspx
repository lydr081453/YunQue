<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Purchase_Requisition_OperationAnalyse" CodeBehind="OperationAnalyse.aspx.cs" %>
                        ...
                        <td colspan="2">
                            <table width="100%" class="tableForm">
                                ...
                                <tr>
                                    ...
                                    <td class="oddrow-l">
                                        <asp:TextBox ID="txtprojectCode" MaxLength="200" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="订单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?backUrl=OperationAnalyse.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("orderid") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="查看" ItemStyle-Width="3%">
                                        ...
                                        <ItemTemplate>
                                            <a href="OrderDetail.aspx?backUrl=OperationAnalyse.aspx&<% =RequestName.GeneralID %>=<%#Eval("id") %>&helpfile=3">
