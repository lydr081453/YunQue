                        ...
                        <td colspan="2">
                            <table width="100%" id="tabTop" runat="server">
                                <tr>
                                    ...
                                    <td align="right" class="recordTd">
                                        Total:<asp:Label runat="server" ID="labTotalT"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 记录数:<asp:Label ID="labAllNumT" runat="server" />&nbsp;页数:<asp:Label ID="labPageCountT"
                                            runat="server" />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" id="tabBottom" runat="server">
                                <tr>
                                    ...
                                    <td align="right" class="recordTd">
                                        Total:<asp:Label runat="server" ID="labTotal"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 记录数:<asp:Label ID="labAllNum" runat="server" />&nbsp;页数:<asp:Label ID="labPageCount"
                                            runat="server" />
                                    </td>
                                </tr>
                            </table>
