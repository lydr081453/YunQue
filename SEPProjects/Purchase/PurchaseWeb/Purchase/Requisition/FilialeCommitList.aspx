<%@ Page Language="C#" AutoEventWireup="true" Inherits="Purchase_Requisition_FilialeCommitList"
    MasterPageFile="~/MasterPage.master" CodeBehind="FilialeCommitList.aspx.cs" %>
                            ...
                            <asp:GridView ID="gvG" runat="server" AutoGenerateColumns="False" DataKeyNames="id,moneytype"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请单号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                            <a href="OrderDetailTab.aspx?backUrl=FilialeCommitList.aspx&helpfile=3&<% =RequestName.GeneralID %>=<%#Eval("id") %>">
                                                <%#Eval("prNO") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
