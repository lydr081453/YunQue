<%@ Page Title="选择物料类别" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Purchase_PRAuthorization_selectType" Codebehind="selectType.aspx.cs" %>
                                    ...
                                    <asp:DataList ID="rep2" runat="server" OnItemDataBound="rep2_ItemDataBound" CssClass="border_datalist"
                                        ...
                                        <ItemTemplate>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="chk" id="chk" value="<%# Eval("typeid") %>" />&nbsp;<asp:Literal ID="lab" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
