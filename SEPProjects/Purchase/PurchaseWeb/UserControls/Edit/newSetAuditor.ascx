<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="UserControls_Edit_newSetAuditor" Codebehind="newSetAuditor.ascx.cs" %>
...
<script language="javascript">
    ...
    function addRow1(type, userId, userName, job, operation, changedTrId, oldId) {
        ...
        if (operation == "add") {
            ...
            if (type == "YS") {
                ...
                tr.cells[3].innerHTML = "10万以上";
                tr.cells[5].innerHTML = getHtml3(type, trId, userId);
            }
        }
        changedSerialNum();
    }
    ...
    function openEmployee(type) {
        ...
        var win = window.open('selectOperationAuditor.aspx?<%= ESP.Purchase.Common.RequestName.GeneralID %>=<%=Request[ESP.Purchase.Common.RequestName.GeneralID] %>&curU=' + currentUser + "&type=" + type, null, 'height=600px,width=800px,scrollbars=yes,top=100px,left=100px');
        win.resizeTo(screen.availWidth * 0.8, screen.availHeight * 0.8);
    }
    function openEmployee1(type, changedTrId, oldId) {
        var currentUser = '<%= CurrentUser.SysID %>';
        var win = window.open('selectOperationAuditor.aspx?<%= ESP.Purchase.Common.RequestName.GeneralID %>=<%=Request[ESP.Purchase.Common.RequestName.GeneralID] %>&changedTrId=' + changedTrId + '&oldId=' + oldId + '&type=' + type + '&curU=' + currentUser, null, 'height=600px,width=800px,scrollbars=yes,top=100px,left=100px');
        win.resizeTo(screen.availWidth * 0.8, screen.availHeight * 0.8);
    }
</script>
...
<asp:HiddenField ID="hidCGSP" runat="server" />
...
<asp:HiddenField ID="hidCGZJSP" runat="server" />
<br />
...
<table border="0" width="100%">
    <tr>
        <td align="center">
            ...
            <asp:Button ID="btnCommit" runat="server" Text="提交" OnClientClick="showLoading();" CssClass="widebuttons" OnClick="btnCommit_Click" />
        </td>
    </tr>
</table>
