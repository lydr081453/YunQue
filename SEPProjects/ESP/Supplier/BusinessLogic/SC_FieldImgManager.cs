...
{
    public class SC_FieldImgManager
    {
        private static readonly SC_FieldImgDataProvider dal = new SC_FieldImgDataProvider();

        public static int Add(SC_FieldImg model,ESP.Compatible.Employee user)
        {
        ...
        public static List<SC_FieldImg> GetList(int fieldId)
        {
