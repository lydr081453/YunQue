...
{
    public class SC_FieldImgDataProvider
    {
        public int Add(SC_FieldImg model, SqlTransaction trans)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" INSERT INTO SC_FieldImg ");
        ...
        public List<SC_FieldImg> GetList(int fieldId)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select * from SC_FieldImg where fieldId=" + fieldId);
            return ESP.Finance.Utility.CBO.FillCollection<SC_FieldImg>(DbHelperSQL.Query(strSql.ToString()));
        }

        public int Delete(int id, SqlTransaction trans)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete SC_FieldImg");
