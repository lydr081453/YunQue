...
{
    public class SupporterForSelectedSQLProvider
    {
        /// <summary>
        /// 是否存在该记录
        /// </summary>
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from [SYP_SupporterForSelected]");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SupporterForSelectedInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [SYP_SupporterForSelected](");
        ...
        public void Delete(int id)
        {
            ...
            string strSql = "delete SYP_SupporterForSelected  where id=" + id.ToString();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SupporterForSelectedInfo GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  SYP_SupporterForSelected.* from SYP_SupporterForSelected ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = id;

            return CBO.FillObject<SupporterForSelectedInfo>(
        ...
        /// 获得数据列表
        /// </summary>
        public IList<SupporterForSelectedInfo> GetList(string term)
        {
            string strSql = "select *  FROM SYP_SupporterForSelected ";
            if (!string.IsNullOrEmpty(term))
            {
                strSql += " where " + term;
            }
            return CBO.FillCollection<SupporterForSelectedInfo>(
        ...
        /// 获得数据列表TOP
        /// </summary>
        public IList<SupporterForSelectedInfo> GetList(string term, int top)
        {
