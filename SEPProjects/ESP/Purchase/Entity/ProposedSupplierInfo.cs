...
{
    /// <summary>
    /// 实体类T_ProposedSupplier 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public class ProposedSupplierInfo
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposedSupplierInfo"/> class.
        /// </summary>
        public ProposedSupplierInfo()
        {
            //
        }
