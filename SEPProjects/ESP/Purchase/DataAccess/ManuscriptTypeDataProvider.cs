...
{
    public class ManuscriptTypeDataProvider
    {
        public ManuscriptTypeDataProvider()
        { }
        ...
        /// <returns></returns>
        public int Add(ManuscriptTypeInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into T_ManuscriptType(");
        ...
        /// <param name="model">The model.</param>
        /// <returns></returns>
        public int Update(ManuscriptTypeInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_ManuscriptType set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete T_ManuscriptType ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,6)};
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        public ManuscriptTypeInfo GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from T_ManuscriptType ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
            ManuscriptTypeInfo model = new ManuscriptTypeInfo();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM T_ManuscriptType ");
            if (strWhere.Trim() != "")
            {
