...
namespace ESP.Administrative.Common
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString =
            System.Configuration.ConfigurationManager.ConnectionStrings["ADSqlConnection"].ConnectionString == ""
            ? ESP.Configuration.ConfigurationManager.SafeConnectionStrings["ADSqlConnection"].ConnectionString
            : System.Configuration.ConfigurationManager.ConnectionStrings["ADSqlConnection"].ConnectionString; //如果要换数据库，你可以参考SysManage;
        ...
        public static DataSet Query(string SQLString)
        {
            ...
            SqlDataAdapter command = new SqlDataAdapter(SQLString, connectionString);
