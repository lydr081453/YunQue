...
{
	/// <summary>
	/// 实体类ProjectHistInfo 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
    [Serializable]
    public partial class ProjectHistInfo
	{
        public ProjectHistInfo()
		{}
		#region Model
		private int _projecthistid;
		...
		private string _changeemployeename;
		private string _changedes;
		...
		/// 
		/// </summary>
		public int ProjectHistID
		{
			set{ _projecthistid=value;}
			get{return _projecthistid;}
		}
		/// <summary>
		/// 分公司ID
		/// </summary>
		...
		{
			set{ _changeemployeename=value;}
			get{return _changeemployeename;}
		}
		/// <summary>
		/// 变更说明
		/// </summary>
		...
		{
			set{ _changedes=value;}
			get{return _changedes;}
		}
		/// <summary>
		/// 变更时间
		/// </summary>
    ...
    public partial class ProjectHistInfo
    {
        ...
        private byte[] _ProjectModel;

        public byte[] ProjectModel
        {
