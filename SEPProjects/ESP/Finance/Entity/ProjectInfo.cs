...
namespace ESP.Finance.Entity
{
    ...
    public partial class ProjectInfo
	{
        ...
        /// 项目类型二级分类
        /// </summary>
        public int? ProjectTypeLevel2ID { get; set; }

        public int? ProjectTypeLevel3ID { get; set; }

        /// <summary>
        /// 客户框架协议ID(前后，号分隔）
        /// </summary>
        public string CustomerAttachID { get; set; }
        ...
        /// 预估媒体成本比例
        /// </summary>
        public decimal? MediaCostRate { get; set; }

        /// <summary>
        /// 预估客户返点比例
        /// </summary>
        public decimal? CustomerRebateRate { get; set; }
        ...
        /// 关联项目ID
        /// </summary>
        public int? RelevanceProjectId { get; set; }

        /// <summary>
        /// 关联项目号
        /// </summary>
        public string RelevanceProjectCode { get; set; }
    ...
    public partial class ProjectInfo
    {
        ...
        public string MediaName 
        {
            get {
                if (MediaId != null)
                {
                    var media = ESP.Purchase.BusinessLogic.SupplierManager.GetModel(MediaId.Value);
                    if (media != null)
        ...
        public bool isRecharge
        {
            get
            {
                return (System.Web.Configuration.WebConfigurationManager.AppSettings["ProjectType_Recharge"].IndexOf(ProjectTypeID == null ? "-1" : ProjectTypeID.Value.ToString())>=0);
        ...
        public decimal? Recharge
        {
            get
            {
                string term = " projectId=" + ProjectId + " and Description='" + ESP.Finance.Utility.ProjectExpense_Desc.Recharge + "'";
                IList<ESP.Finance.Entity.ProjectExpenseInfo> list = ESP.Finance.BusinessLogic.ProjectExpenseManager.GetList(term);
                if (list != null && list.Count > 0)
                {
                    return Math.Round( list[0].Expense.Value,2);
                }
                return 0;
            }
        }
        ...
        public decimal? MediaCost
        {
            get
            {
                IList<ProjectMediaInfo> pmList = ESP.Finance.BusinessLogic.ProjectMediaManager.GetList(" projectId=" + ProjectId);
                if (pmList.Count <= 1)
                    return Math.Round( (Recharge ?? 0) * (MediaCostRate ?? 0),2);
                else
                {
                    decimal _mediaCost = 0m;
                    foreach (var pm in pmList)
                    {
                        _mediaCost += pm.Recharge * pm.CostRate;
                    }
                    return Math.Round( _mediaCost,2);
                }
            }
        }
        ...
        /// 预估客户返点金额（只读）
        /// </summary>
        public decimal? CustomerRebate
        {
            get
            {
                return Math.Round(((TotalAmount ?? 0) * (CustomerRebateRate ?? 0)),2);
            }
        }
        ...
        public decimal? AccountsReceivable
        {
            get
            {
                return Math.Round((TotalAmount ?? 0) * (1 - (CustomerRebateRate ?? 0)),2);
            }
        }
        ...
        private IList<ProjectMemberInfo> _members;
        /// <summary>
        /// 项目成员
        /// </summary>
        public IList<ProjectMemberInfo> Members
        {
            get
            {
                if (_members == null)
                    _members = new List<ProjectMemberInfo>();
                return _members;
            }
            set { _members = value; }
        }
        ...
        private IList<ContractInfo> _contracts;
        /// <summary>
        /// 项目合同
        /// </summary>
        public IList<ContractInfo> Contracts
        {
        ...
        private IList<SupporterInfo> _supporters;
        /// <summary>
        /// 支持方
        /// </summary>
        public IList<SupporterInfo> Supporters
        {
            get { return _supporters; }
            set { _supporters = value; }
        }


        private IList<PaymentInfo> _payments;
        /// <summary>
        /// 付款通知
        /// </summary>
        public IList<PaymentInfo> Payments
        {
            get { return _payments; }
            set { _payments = value; }
        }

        IList<ContractCostInfo> _costDetails;
        /// <summary>
        /// 成本明细
        /// </summary>
        public IList<ContractCostInfo> CostDetails
        {
            get { return _costDetails; }
            set { _costDetails = value; }
        }

        private IList<ProjectScheduleInfo> _projectSchedule;

        /// <summary>
        /// 各月完工百分比
        /// </summary>
        public IList<ProjectScheduleInfo> ProjectSchedules
        {
            get { return _projectSchedule; }
            set { _projectSchedule = value; }
        }

        private IList<ProjectExpenseInfo> _Expense;

        /// <summary>
        /// OOP
        /// </summary>
        public IList<ProjectExpenseInfo> Expenses
        {
            get { return _Expense; }
            set { _Expense = value; }
        }
        ...
        private CustomerTmpInfo _customer;
        /// <summary>
        /// 客户信息
        /// </summary>
        public CustomerTmpInfo Customer
        {
        ...
        private IList<ConsumptionInfo> _Consumptions;
        /// <summary>
        /// 消耗
        /// </summary>
        public IList<ConsumptionInfo> Consumptions
        {
