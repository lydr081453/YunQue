...
namespace ESP.Finance.DataAccess
{
    ...
    public sealed class DbHelperSQL
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            //catch (Exception ex)
            //{
            //    throw new Exception(string.Format("事务标签处理错误:--------{0}", ex.Message), ex);
            //}
            //------------有事务标签------------------
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader ExecuteReader(string strSQL, List<SqlParameter> param)
        {
            SqlConnection connection = null;
            try
            {
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>SqlDataReader</returns>
        public static object ExecuteScalar(string strSQL, List<SqlParameter> param)
        {
            using(SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(strSQL, connection))
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string SQLString,string newconnstring, params SqlParameter[] cmdParms)
        {
        ...
        public static object GetSingle(string SQLString,string newconnstring, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(newconnstring))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        public static int RunProcedure(string storedProcName, IDataParameter[] parameters, SqlTransaction trans, out int rowsAffected)
        {
            if (trans == null)
                return RunProcedure(storedProcName, parameters, out rowsAffected);
            int result;
            SqlCommand command = BuildIntCommand(trans.Connection, storedProcName, parameters);
