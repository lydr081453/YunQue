...
namespace ESP.Media.Common
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString = ESP.Configuration.ConfigurationManager.SafeConnectionStrings["MediaSqlConnection"].ConnectionString; //如果要换数据库，你可以参考SysManage       		
        public DbHelperSQL()
        {
        }
