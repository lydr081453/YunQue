...
{
    public class WordClassManager : IDisposable
    {
        #region 字段
        ...
        {
            m_WordApp.ActiveWindow.View.Type = WdViewType.wdOutlineView;
            m_WordApp.ActiveWindow.View.SeekView = WdSeekView.wdSeekPrimaryHeader;
            m_WordApp.ActiveWindow.ActivePane.Selection.InsertAfter(text); //插入文本
            m_WordApp.Selection.ParagraphFormat.Alignment = align;  //设置对齐方式
            m_WordApp.ActiveWindow.View.SeekView = WdSeekView.wdSeekMainDocument; // 跳出页眉设置
        }
        /// <summary>
        /// 插入页脚
        /// </summary>
        ...
        {
            m_WordApp.ActiveWindow.View.Type = WdViewType.wdOutlineView;
            m_WordApp.ActiveWindow.View.SeekView = WdSeekView.wdSeekPrimaryFooter;
            m_WordApp.ActiveWindow.ActivePane.Selection.InsertAfter(text); //插入文本
            m_WordApp.Selection.ParagraphFormat.Alignment = align;  //设置对齐方式
            m_WordApp.ActiveWindow.View.SeekView = WdSeekView.wdSeekMainDocument; // 跳出页眉设置
        }
