...
{
    public class ProjectpersonfeebillrelationManager
    {
        public static int add(ProjectpersonfeebillrelationInfo relation, int userid, SqlTransaction trans)
        {
            ...
            //{
                return ESP.Media.DataAccess.ProjectpersonfeebillrelationDataProvider.insertinfo(relation, trans);
            //}
            //return 0;
        }
        ...
        {
            string term = " and Personfeebillid=@Personfeebillid and a.del!=@del";
            ...
            {
                ProjectpersonfeebillrelationInfo relation = new ESP.Media.Entity.ProjectpersonfeebillrelationInfo();
                relation.Personfeebillid = billid;
        ...
        {
            return ESP.Media.DataAccess.ProjectpersonfeebillrelationDataProvider.DeleteInfo(id, trans);
        }
        ...
        {
            string sql = @"select a.id as id,a.Personfeebillid as Personfeebillid,a.projectid as projectid,a.del as del, project.projectcode as projectcode from Media_projectpersonfeebillrelation as a 
        ...
        public static DataTable GetListByBillID(int billid, string term, Hashtable ht)
        {
            ...
            if (ht == null)
                ht = new Hashtable();
            term += " and Personfeebillid=@Personfeebillid and a.del!=@del";
