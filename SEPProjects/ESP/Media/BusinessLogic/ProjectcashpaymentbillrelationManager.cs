...
{
    public class ProjectcashpaymentbillrelationManager
    {
        public static int add(ProjectcashpaymentbillrelationInfo relation, int userid, SqlTransaction trans)
        {
            ...
            //{
            return ESP.Media.DataAccess.ProjectcashpaymentbillrelationDataProvider.insertinfo(relation, trans);
            //}
            //return 0;
        }
        ...
        {
            string term = " and Cashpaymentbillid=@Cashpaymentbillid and a.del!=@del";
            ...
            {
                ProjectcashpaymentbillrelationInfo relation = new ProjectcashpaymentbillrelationInfo();
                relation.Cashpaymentbillid = billid;
        ...
        {
            return ESP.Media.DataAccess.ProjectcashpaymentbillrelationDataProvider.DeleteInfo(id, trans);
        }
        ...
        {
            string sql = @"select a.id as id,a.cashpaymentbillid as cashpaymentbillid,a.projectid as projectid,a.del as del, project.projectcode as projectcode 
                            from Media_projectcashpaymentbillrelation as a 
        ...
        public static DataTable GetListByBillID(int billid, string term, Hashtable ht)
        {
            ...
            if (ht == null)
                ht = new Hashtable();
           term += " and Cashpaymentbillid=@Cashpaymentbillid and a.del!=@del";
