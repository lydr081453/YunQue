...
{
    public class CashpaymentbillDataProvider
    {
        #region 构造函数
        public CashpaymentbillDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(CashpaymentbillInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_cashpaymentbill (createip,createdate,userid,username,userdepartmentid,userdepartmentname,describe,userextensioncode,reimbursedate,del,projectid,projectcode,status) values (@createip,@createdate,@userid,@username,@userdepartmentid,@userdepartmentname,@describe,@userextensioncode,@reimbursedate,@del,@projectid,@projectcode,@status);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(CashpaymentbillInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(CashpaymentbillInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_cashpaymentbill where cashpaymentbillid=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(CashpaymentbillInfo objTerm, CashpaymentbillInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_cashpaymentbill set createip=@createip,createdate=@createdate,userid=@userid,username=@username,userdepartmentid=@userdepartmentid,userdepartmentname=@userdepartmentname,describe=@describe,userextensioncode=@userextensioncode,reimbursedate=@reimbursedate,del=@del,projectid=@projectid,projectcode=@projectcode,status=@status where 1=1 ";
            SqlParameter param_createip = new SqlParameter("@createip", SqlDbType.NVarChar, 40);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, CashpaymentbillInfo objterm, CashpaymentbillInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(CashpaymentbillInfo objterm, CashpaymentbillInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(CashpaymentbillInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(CashpaymentbillInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Cashpaymentbillid > 0)//cashpaymentbillid
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.cashpaymentbillid as cashpaymentbillid,a.createip as createip,a.createdate as createdate,a.userid as userid,a.username as username,a.userdepartmentid as userdepartmentid,a.userdepartmentname as userdepartmentname,a.describe as describe,a.userextensioncode as userextensioncode,a.reimbursedate as reimbursedate,a.del as del,a.projectid as projectid,a.projectcode as projectcode,a.status as status {1} from media_cashpaymentbill as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(CashpaymentbillInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(CashpaymentbillInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static CashpaymentbillInfo Load(int id)
        {
            DataTable dt = null;
            dt = QueryInfo(" and a.cashpaymentbillid=@id ", new SqlParameter("@id", id));
        ...
        public static CashpaymentbillInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
            dt = QueryInfo(trans, " and a.cashpaymentbillid=@id ", new SqlParameter("@id", id));
            if (dt != null && dt.Rows.Count > 0)
            {
                return setObject(dt.Rows[0]);
            }
        ...
        public static CashpaymentbillInfo setObject(DataRow dr)
        {
            CashpaymentbillInfo obj = new CashpaymentbillInfo();
