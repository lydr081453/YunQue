...
{
    public class EventbriefDataProvider
    {
        #region 构造函数
        public EventbriefDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(EventbriefInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_eventbrief (eventid,reporterid,mediaitemtypeid,des,del,linkurl,filepath,createdbyuserid,createdip,createddate,briefsubject,wordsaccount,mediaitemid,paymentid,issuedate,projectid) values (@eventid,@reporterid,@mediaitemtypeid,@des,@del,@linkurl,@filepath,@createdbyuserid,@createdip,@createddate,@briefsubject,@wordsaccount,@mediaitemid,@paymentid,@issuedate,@projectid);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(EventbriefInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(EventbriefInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_eventbrief where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(EventbriefInfo objTerm, EventbriefInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_eventbrief set eventid=@eventid,reporterid=@reporterid,mediaitemtypeid=@mediaitemtypeid,des=@des,del=@del,linkurl=@linkurl,filepath=@filepath,createdbyuserid=@createdbyuserid,createdip=@createdip,createddate=@createddate,briefsubject=@briefsubject,wordsaccount=@wordsaccount,mediaitemid=@mediaitemid,paymentid=@paymentid,issuedate=@issuedate,projectid=@projectid where 1=1 ";
            SqlParameter param_eventid = new SqlParameter("@eventid", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, EventbriefInfo objterm, EventbriefInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(EventbriefInfo objterm, EventbriefInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(EventbriefInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(EventbriefInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.eventid as eventid,a.reporterid as reporterid,a.mediaitemtypeid as mediaitemtypeid,a.des as des,a.del as del,a.linkurl as linkurl,a.filepath as filepath,a.createdbyuserid as createdbyuserid,a.createdip as createdip,a.createddate as createddate,a.briefsubject as briefsubject,a.wordsaccount as wordsaccount,a.mediaitemid as mediaitemid,a.paymentid as paymentid,a.issuedate as issuedate,a.projectid as projectid {1} from media_eventbrief as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(EventbriefInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(EventbriefInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static EventbriefInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static EventbriefInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static EventbriefInfo setObject(DataRow dr)
        {
            EventbriefInfo obj = new EventbriefInfo();
