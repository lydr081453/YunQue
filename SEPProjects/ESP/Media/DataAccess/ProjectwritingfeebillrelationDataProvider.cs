...
{
    public class ProjectwritingfeebillrelationDataProvider
    {
        #region 构造函数
        public ProjectwritingfeebillrelationDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(ProjectwritingfeebillrelationInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_projectwritingfeebillrelation (writingfeebillid,projectid,del) values (@writingfeebillid,@projectid,@del);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(ProjectwritingfeebillrelationInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(ProjectwritingfeebillrelationInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_projectwritingfeebillrelation where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(ProjectwritingfeebillrelationInfo objTerm, ProjectwritingfeebillrelationInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_projectwritingfeebillrelation set writingfeebillid=@writingfeebillid,projectid=@projectid,del=@del where 1=1 ";
            SqlParameter param_writingfeebillid = new SqlParameter("@writingfeebillid", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, ProjectwritingfeebillrelationInfo objterm, ProjectwritingfeebillrelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(ProjectwritingfeebillrelationInfo objterm, ProjectwritingfeebillrelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(ProjectwritingfeebillrelationInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(ProjectwritingfeebillrelationInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.writingfeebillid as writingfeebillid,a.projectid as projectid,a.del as del {1} from media_projectwritingfeebillrelation as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(ProjectwritingfeebillrelationInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(ProjectwritingfeebillrelationInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static ProjectwritingfeebillrelationInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static ProjectwritingfeebillrelationInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static ProjectwritingfeebillrelationInfo setObject(DataRow dr)
        {
            ProjectwritingfeebillrelationInfo obj = new ProjectwritingfeebillrelationInfo();
