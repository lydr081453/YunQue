...
{
    public class CheckpaymentbillDataProvider
    {
        #region 构造函数
        public CheckpaymentbillDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(CheckpaymentbillInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_checkpaymentbill (createip,createdate,userid,username,userdepartmentid,userdepartmentname,describe,del,projectid,projectcode,userextensioncode,reimbursedate,companyname,bankname,bankaccount,status) values (@createip,@createdate,@userid,@username,@userdepartmentid,@userdepartmentname,@describe,@del,@projectid,@projectcode,@userextensioncode,@reimbursedate,@companyname,@bankname,@bankaccount,@status);select @@IDENTITY as rowNum;";
            ...
            SqlParameter param_Companyname = new SqlParameter("@Companyname", SqlDbType.NVarChar, 200);
        ...
        //插入一条记录
        public static int insertinfo(CheckpaymentbillInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(CheckpaymentbillInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_checkpaymentbill where checkpaymentbillid=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(CheckpaymentbillInfo objTerm, CheckpaymentbillInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_checkpaymentbill set createip=@createip,createdate=@createdate,userid=@userid,username=@username,userdepartmentid=@userdepartmentid,userdepartmentname=@userdepartmentname,describe=@describe,del=@del,projectid=@projectid,projectcode=@projectcode,userextensioncode=@userextensioncode,reimbursedate=@reimbursedate,companyname=@companyname,bankname=@bankname,bankaccount=@bankaccount,status=@status where 1=1 ";
            SqlParameter param_createip = new SqlParameter("@createip", SqlDbType.NVarChar, 40);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, CheckpaymentbillInfo objterm, CheckpaymentbillInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(CheckpaymentbillInfo objterm, CheckpaymentbillInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(CheckpaymentbillInfo obj, ref List<SqlParameter> ht)
        {
            ...
            if (obj.Companyname != null && obj.Companyname.Trim().Length > 0)
            {
                ...
                {
                    SqlParameter p = new SqlParameter("@companyname", SqlDbType.NVarChar, 200);
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(CheckpaymentbillInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Checkpaymentbillid > 0)//checkpaymentbillid
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.checkpaymentbillid as checkpaymentbillid,a.createip as createip,a.createdate as createdate,a.userid as userid,a.username as username,a.userdepartmentid as userdepartmentid,a.userdepartmentname as userdepartmentname,a.describe as describe,a.del as del,a.projectid as projectid,a.projectcode as projectcode,a.userextensioncode as userextensioncode,a.reimbursedate as reimbursedate,a.companyname as companyname,a.bankname as bankname,a.bankaccount as bankaccount,a.status as status {1} from media_checkpaymentbill as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(CheckpaymentbillInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(CheckpaymentbillInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static CheckpaymentbillInfo Load(int id)
        {
            DataTable dt = null;
            dt = QueryInfo(" and a.checkpaymentbillid=@id ", new SqlParameter("@id", id));
        ...
        public static CheckpaymentbillInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
            dt = QueryInfo(trans, " and a.checkpaymentbillid=@id ", new SqlParameter("@id", id));
            if (dt != null && dt.Rows.Count > 0)
            {
                return setObject(dt.Rows[0]);
            }
        ...
        public static CheckpaymentbillInfo setObject(DataRow dr)
        {
            CheckpaymentbillInfo obj = new CheckpaymentbillInfo();
