...
{
    public class ClientshistDataProvider
    {
        #region 构造函数
        public ClientshistDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(ClientshistInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_clientshist (version,clientid,clientcfullname,clientcshortname,clientefullname,clienteshortname,clientlogo,clientdescription,currentversion,status,createdbyuserid,createdip,createddate,lastmodifiedbyuserid,lastmodifiedip,lastmodifieddate,del) values (@version,@clientid,@clientcfullname,@clientcshortname,@clientefullname,@clienteshortname,@clientlogo,@clientdescription,@currentversion,@status,@createdbyuserid,@createdip,@createddate,@lastmodifiedbyuserid,@lastmodifiedip,@lastmodifieddate,@del);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(ClientshistInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(ClientshistInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_clientshist where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(ClientshistInfo objTerm, ClientshistInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_clientshist set version=@version,clientid=@clientid,clientcfullname=@clientcfullname,clientcshortname=@clientcshortname,clientefullname=@clientefullname,clienteshortname=@clienteshortname,clientlogo=@clientlogo,clientdescription=@clientdescription,currentversion=@currentversion,status=@status,createdbyuserid=@createdbyuserid,createdip=@createdip,createddate=@createddate,lastmodifiedbyuserid=@lastmodifiedbyuserid,lastmodifiedip=@lastmodifiedip,lastmodifieddate=@lastmodifieddate,del=@del where 1=1 ";
            SqlParameter param_version = new SqlParameter("@version", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, ClientshistInfo objterm, ClientshistInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(ClientshistInfo objterm, ClientshistInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(ClientshistInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(ClientshistInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.version as version,a.clientid as clientid,a.clientcfullname as clientcfullname,a.clientcshortname as clientcshortname,a.clientefullname as clientefullname,a.clienteshortname as clienteshortname,a.clientlogo as clientlogo,a.clientdescription as clientdescription,a.currentversion as currentversion,a.status as status,a.createdbyuserid as createdbyuserid,a.createdip as createdip,a.createddate as createddate,a.lastmodifiedbyuserid as lastmodifiedbyuserid,a.lastmodifiedip as lastmodifiedip,a.lastmodifieddate as lastmodifieddate,a.del as del {1} from media_clientshist as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(ClientshistInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(ClientshistInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static ClientshistInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static ClientshistInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static ClientshistInfo setObject(DataRow dr)
        {
            ClientshistInfo obj = new ClientshistInfo();
