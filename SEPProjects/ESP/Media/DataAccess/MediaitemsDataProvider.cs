...
{
    public class MediaitemsDataProvider
    {
        #region 构造函数
        public MediaitemsDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(MediaitemsInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_mediaitems (mediacname,mediaename,cshortname,eshortname,mediaitemtype,currentversion,status,createdbyuserid,createdip,createddate,lastmodifiedbyuserid,lastmodifieddate,lastmodifiedip,mediumsort,readersort,governingbody,frontfor,proprieter,subproprieter,chiefeditor,admineditor,subeditor,manager,zhuren,producer,startpublication,publishdate,telephoneexchange,fax,addressone,addresstwo,webaddress,issn,cooperate,circulation,publishchannels,phoneone,phonetwo,endpublication,adsphone,adsprice,medialogo,briefing,mediaintro,engintro,remarks,channelname,dabfm,topicname,topicproperty,overriderange,rating,topictime,channelwebaddress,countryid,provinceid,cityid,del,mediatype,addr1_provinceid,addr1_cityid,addr1_countryid,addr2_provinceid,addr2_cityid,addr2_countryid,postcode,regionattribute,override_countryid,override_provinceid,override_cityid,override_describe,industryid,issueregion,publishperiods) values (@mediacname,@mediaename,@cshortname,@eshortname,@mediaitemtype,@currentversion,@status,@createdbyuserid,@createdip,@createddate,@lastmodifiedbyuserid,@lastmodifieddate,@lastmodifiedip,@mediumsort,@readersort,@governingbody,@frontfor,@proprieter,@subproprieter,@chiefeditor,@admineditor,@subeditor,@manager,@zhuren,@producer,@startpublication,@publishdate,@telephoneexchange,@fax,@addressone,@addresstwo,@webaddress,@issn,@cooperate,@circulation,@publishchannels,@phoneone,@phonetwo,@endpublication,@adsphone,@adsprice,@medialogo,@briefing,@mediaintro,@engintro,@remarks,@channelname,@dabfm,@topicname,@topicproperty,@overriderange,@rating,@topictime,@channelwebaddress,@countryid,@provinceid,@cityid,@del,@mediatype,@addr1_provinceid,@addr1_cityid,@addr1_countryid,@addr2_provinceid,@addr2_cityid,@addr2_countryid,@postcode,@regionattribute,@override_countryid,@override_provinceid,@override_cityid,@override_describe,@industryid,@issueregion,@publishperiods);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(MediaitemsInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(MediaitemsInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_mediaitems where MediaitemID=@id";
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, MediaitemsInfo objterm, MediaitemsInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(MediaitemsInfo objterm, MediaitemsInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(MediaitemsInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(MediaitemsInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Mediaitemid > 0)//MediaitemID
            {
        ...
        public static DataTable QueryInfo(string terms, params SqlParameter[] param)
        {
            ...
            {
                ESP.Logging.Logger.Add("select media is error.", "Media system", ESP.Logging.LogLevel.Information, ex);
            }
            return dt;
        }
        ...
        public static DataTable QueryInfoByObj(MediaitemsInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(MediaitemsInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static MediaitemsInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static MediaitemsInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static MediaitemsInfo setObject(DataRow dr)
        {
            MediaitemsInfo obj = new MediaitemsInfo();
