...
{
    public class DailymediarelationDataProvider
    {
        #region 构造函数
        public DailymediarelationDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(DailymediarelationInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_dailymediarelation (dailyid,mediaitemid,relationdate,relationuserid,remark,del) values (@dailyid,@mediaitemid,@relationdate,@relationuserid,@remark,@del);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(DailymediarelationInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(DailymediarelationInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_dailymediarelation where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(DailymediarelationInfo objTerm, DailymediarelationInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_dailymediarelation set dailyid=@dailyid,mediaitemid=@mediaitemid,relationdate=@relationdate,relationuserid=@relationuserid,remark=@remark,del=@del where 1=1 ";
            SqlParameter param_dailyid = new SqlParameter("@dailyid", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, DailymediarelationInfo objterm, DailymediarelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(DailymediarelationInfo objterm, DailymediarelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(DailymediarelationInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(DailymediarelationInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.dailyid as dailyid,a.mediaitemid as mediaitemid,a.relationdate as relationdate,a.relationuserid as relationuserid,a.remark as remark,a.del as del {1} from media_dailymediarelation as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(DailymediarelationInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(DailymediarelationInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static DailymediarelationInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static DailymediarelationInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static DailymediarelationInfo setObject(DataRow dr)
        {
            DailymediarelationInfo obj = new DailymediarelationInfo();
