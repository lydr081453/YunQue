...
{
    public class ProductlineshistDataProvider
    {
        #region 构造函数
        public ProductlineshistDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(ProductlineshistInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_productlineshist (version,productlineid,productlinename,productlinedescription,productlinetitle,clientid,currentversion,status,createdbyuserid,createdip,createddate,lastmodifiedbyuserid,lastmodifiedip,lastmodifieddate,del) values (@version,@productlineid,@productlinename,@productlinedescription,@productlinetitle,@clientid,@currentversion,@status,@createdbyuserid,@createdip,@createddate,@lastmodifiedbyuserid,@lastmodifiedip,@lastmodifieddate,@del);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(ProductlineshistInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(ProductlineshistInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_productlineshist where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(ProductlineshistInfo objTerm, ProductlineshistInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_productlineshist set version=@version,productlineid=@productlineid,productlinename=@productlinename,productlinedescription=@productlinedescription,productlinetitle=@productlinetitle,clientid=@clientid,currentversion=@currentversion,status=@status,createdbyuserid=@createdbyuserid,createdip=@createdip,createddate=@createddate,lastmodifiedbyuserid=@lastmodifiedbyuserid,lastmodifiedip=@lastmodifiedip,lastmodifieddate=@lastmodifieddate,del=@del where 1=1 ";
            SqlParameter param_version = new SqlParameter("@version", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, ProductlineshistInfo objterm, ProductlineshistInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(ProductlineshistInfo objterm, ProductlineshistInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(ProductlineshistInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(ProductlineshistInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.version as version,a.productlineid as productlineid,a.productlinename as productlinename,a.productlinedescription as productlinedescription,a.productlinetitle as productlinetitle,a.clientid as clientid,a.currentversion as currentversion,a.status as status,a.createdbyuserid as createdbyuserid,a.createdip as createdip,a.createddate as createddate,a.lastmodifiedbyuserid as lastmodifiedbyuserid,a.lastmodifiedip as lastmodifiedip,a.lastmodifieddate as lastmodifieddate,a.del as del {1} from media_productlineshist as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(ProductlineshistInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(ProductlineshistInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static ProductlineshistInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static ProductlineshistInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static ProductlineshistInfo setObject(DataRow dr)
        {
            ProductlineshistInfo obj = new ProductlineshistInfo();
