...
{
    public class ProjectpersonfeebillrelationDataProvider
    {
        #region 构造函数
        public ProjectpersonfeebillrelationDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(ProjectpersonfeebillrelationInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_projectpersonfeebillrelation (personfeebillid,projectid,del) values (@personfeebillid,@projectid,@del);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(ProjectpersonfeebillrelationInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(ProjectpersonfeebillrelationInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_projectpersonfeebillrelation where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(ProjectpersonfeebillrelationInfo objTerm, ProjectpersonfeebillrelationInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_projectpersonfeebillrelation set personfeebillid=@personfeebillid,projectid=@projectid,del=@del where 1=1 ";
            SqlParameter param_personfeebillid = new SqlParameter("@personfeebillid", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, ProjectpersonfeebillrelationInfo objterm, ProjectpersonfeebillrelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(ProjectpersonfeebillrelationInfo objterm, ProjectpersonfeebillrelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(ProjectpersonfeebillrelationInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(ProjectpersonfeebillrelationInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.personfeebillid as personfeebillid,a.projectid as projectid,a.del as del {1} from media_projectpersonfeebillrelation as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(ProjectpersonfeebillrelationInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(ProjectpersonfeebillrelationInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static ProjectpersonfeebillrelationInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static ProjectpersonfeebillrelationInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static ProjectpersonfeebillrelationInfo setObject(DataRow dr)
        {
            ProjectpersonfeebillrelationInfo obj = new ProjectpersonfeebillrelationInfo();
