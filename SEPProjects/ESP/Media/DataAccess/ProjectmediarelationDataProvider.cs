...
{
    public class ProjectmediarelationDataProvider
    {
        #region 构造函数
        public ProjectmediarelationDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(ProjectmediarelationInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_projectmediarelation (projectid,mediaitemid,relationdate,relationuserid,remark,del) values (@projectid,@mediaitemid,@relationdate,@relationuserid,@remark,@del);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(ProjectmediarelationInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(ProjectmediarelationInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_projectmediarelation where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(ProjectmediarelationInfo objTerm, ProjectmediarelationInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_projectmediarelation set projectid=@projectid,mediaitemid=@mediaitemid,relationdate=@relationdate,relationuserid=@relationuserid,remark=@remark,del=@del where 1=1 ";
            SqlParameter param_projectid = new SqlParameter("@projectid", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, ProjectmediarelationInfo objterm, ProjectmediarelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(ProjectmediarelationInfo objterm, ProjectmediarelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(ProjectmediarelationInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(ProjectmediarelationInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.projectid as projectid,a.mediaitemid as mediaitemid,a.relationdate as relationdate,a.relationuserid as relationuserid,a.remark as remark,a.del as del {1} from media_projectmediarelation as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(ProjectmediarelationInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(ProjectmediarelationInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static ProjectmediarelationInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static ProjectmediarelationInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static ProjectmediarelationInfo setObject(DataRow dr)
        {
            ProjectmediarelationInfo obj = new ProjectmediarelationInfo();
