...
{
    public class FacetofaceDataProvider
    {
        #region 构造函数
        public FacetofaceDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(FacetofaceInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_facetoface (cycle,createuserid,createdate,path,subject,remark) values (@cycle,@createuserid,@createdate,@path,@subject,@remark);select @@IDENTITY as rowNum;";
        ...
        //插入一条记录
        public static int insertinfo(FacetofaceInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(FacetofaceInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_facetoface where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(FacetofaceInfo objTerm, FacetofaceInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_facetoface set cycle=@cycle,createuserid=@createuserid,createdate=@createdate,path=@path,subject=@subject,remark=@remark where 1=1 ";
            SqlParameter param_cycle = new SqlParameter("@cycle", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, FacetofaceInfo objterm, FacetofaceInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(FacetofaceInfo objterm, FacetofaceInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(FacetofaceInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(FacetofaceInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.cycle as cycle,a.createuserid as createuserid,a.createdate as createdate,a.path as path,a.subject as subject,a.remark as remark {1} from media_facetoface as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(FacetofaceInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(FacetofaceInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static FacetofaceInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static FacetofaceInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static FacetofaceInfo setObject(DataRow dr)
        {
            FacetofaceInfo obj = new FacetofaceInfo();
