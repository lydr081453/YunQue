...
{
    public class CustomercontentsDataProvider
    {
        #region 构造函数
        public CustomercontentsDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(CustomercontentsInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_customercontents (customerid,version,contentxml,modifiedbyuserid,modifiedip,modifieddate,del) values (@customerid,@version,@contentxml,@modifiedbyuserid,@modifiedip,@modifieddate,@del);select @@IDENTITY as rowNum;";
            SqlParameter param_Customerid = new SqlParameter("@Customerid", SqlDbType.Int, 4);
            param_Customerid.Value = obj.Customerid;
            ht.Add(param_Customerid);
        ...
        //插入一条记录
        public static int insertinfo(CustomercontentsInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(CustomercontentsInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_customercontents where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(CustomercontentsInfo objTerm, CustomercontentsInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_customercontents set customerid=@customerid,version=@version,contentxml=@contentxml,modifiedbyuserid=@modifiedbyuserid,modifiedip=@modifiedip,modifieddate=@modifieddate,del=@del where 1=1 ";
            SqlParameter param_customerid = new SqlParameter("@customerid", SqlDbType.Int, 4);
            param_customerid.Value = Objupdate.Customerid;
            ht.Add(param_customerid);
            SqlParameter param_version = new SqlParameter("@version", SqlDbType.Int, 4);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, CustomercontentsInfo objterm, CustomercontentsInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(CustomercontentsInfo objterm, CustomercontentsInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(CustomercontentsInfo obj, ref List<SqlParameter> ht)
        {
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(CustomercontentsInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.customerid as customerid,a.version as version,a.contentxml as contentxml,a.modifiedbyuserid as modifiedbyuserid,a.modifiedip as modifiedip,a.modifieddate as modifieddate,a.del as del {1} from media_customercontents as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(CustomercontentsInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(CustomercontentsInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static CustomercontentsInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static CustomercontentsInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static CustomercontentsInfo setObject(DataRow dr)
        {
            CustomercontentsInfo obj = new CustomercontentsInfo();
            if (dr.Table.Columns.Contains("id") && dr["id"] != DBNull.Value)//id
            {
                obj.Id = Convert.ToInt32(dr["id"]);
            }
            if (dr.Table.Columns.Contains("customerid") && dr["customerid"] != DBNull.Value)//顾客ID
            {
