...
{
    public class ProjectreporterrelationDataProvider
    {
        #region 构造函数
        public ProjectreporterrelationDataProvider()
        {
        }
        #endregion
        #region 插入
        //插入字符串
        private static string strinsert(ProjectreporterrelationInfo obj, ref List<SqlParameter> ht)
        {
            if (ht == null)
            {
                ht = new List<SqlParameter>();
            }
            string sql = @"insert into media_projectreporterrelation (projectid,reporterid,relationdate,relationuserid,privateinfoid,remark,del,paytype,bankname,bankcardcode,bankcardname,bankacountname,writingfee,referral,haveinvoice,paystatus,uploadstarttime,uploadendtime,paymentmode,privateremark,cooperatecircs,financecode) values (@projectid,@reporterid,@relationdate,@relationuserid,@privateinfoid,@remark,@del,@paytype,@bankname,@bankcardcode,@bankcardname,@bankacountname,@writingfee,@referral,@haveinvoice,@paystatus,@uploadstarttime,@uploadendtime,@paymentmode,@privateremark,@cooperatecircs,@financecode);select @@IDENTITY as rowNum;";
            ...
            SqlParameter param_Privateinfoid = new SqlParameter("@Privateinfoid", SqlDbType.Int, 4);
            param_Privateinfoid.Value = obj.Privateinfoid;
            ht.Add(param_Privateinfoid);
        ...
        //插入一条记录
        public static int insertinfo(ProjectreporterrelationInfo obj, SqlTransaction trans)
        {
            if (obj == null)
            {
                return 0;
        ...
        //插入一条记录
        public static int insertinfo(ProjectreporterrelationInfo obj)
        {
            if (obj == null)
            {
                return 0;
        ...
        {
            int rows = 0;
            string sql = "delete media_projectreporterrelation where id=@id";
        ...
        #region 更新
        //更新sql
        public static string getUpdateString(ProjectreporterrelationInfo objTerm, ProjectreporterrelationInfo Objupdate, string term, ref List<SqlParameter> ht, params SqlParameter[] param)
        {
            string sql = "update media_projectreporterrelation set projectid=@projectid,reporterid=@reporterid,relationdate=@relationdate,relationuserid=@relationuserid,privateinfoid=@privateinfoid,remark=@remark,del=@del,paytype=@paytype,bankname=@bankname,bankcardcode=@bankcardcode,bankcardname=@bankcardname,bankacountname=@bankacountname,writingfee=@writingfee,referral=@referral,haveinvoice=@haveinvoice,paystatus=@paystatus,uploadstarttime=@uploadstarttime,uploadendtime=@uploadendtime,paymentmode=@paymentmode,privateremark=@privateremark,cooperatecircs=@cooperatecircs,financecode=@financecode where 1=1 ";
            SqlParameter param_projectid = new SqlParameter("@projectid", SqlDbType.Int, 4);
            ...
            ht.Add(param_relationuserid);
            SqlParameter param_privateinfoid = new SqlParameter("@privateinfoid", SqlDbType.Int, 4);
            param_privateinfoid.Value = Objupdate.Privateinfoid;
            ht.Add(param_privateinfoid);
            SqlParameter param_remark = new SqlParameter("@remark", SqlDbType.NVarChar, 1000);
        ...
        //更新操作
        public static bool updateInfo(SqlTransaction trans, ProjectreporterrelationInfo objterm, ProjectreporterrelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        //更新操作
        public static bool updateInfo(ProjectreporterrelationInfo objterm, ProjectreporterrelationInfo Objupdate, string term, params SqlParameter[] param)
        {
            if (Objupdate == null)
            {
                return false;
        ...
        private static string getTerms(ProjectreporterrelationInfo obj, ref List<SqlParameter> ht)
        {
            ...
            if (obj.Privateinfoid > 0)//私密信息id
            {
                term += " and privateinfoid=@privateinfoid ";
                if (ESP.Media.Access.Utilities.Common.Find(ht, "@privateinfoid") == -1)
                {
                    SqlParameter p = new SqlParameter("@privateinfoid", SqlDbType.Int, 4);
                    p.Value = obj.Privateinfoid;
                    ht.Add(p);
                }
            }
        ...
        #endregion
        #region 查询
        private static string getQueryTerms(ProjectreporterrelationInfo obj, ref Hashtable ht)
        {
            string term = string.Empty;
            if (obj.Id > 0)//id
            {
            ...
            if (obj.Privateinfoid > 0)//私密信息id
            {
                term += " and a.privateinfoid=@privateinfoid ";
                if (!ht.ContainsKey("@privateinfoid"))
                {
                    ht.Add("@privateinfoid", obj.Privateinfoid);
                }
            }
            if (obj.Remark != null && obj.Remark.Trim().Length > 0)
            {
        ...
        private static string getQueryString(string front, string columns, string LinkTable, string terms)
        {
            ...
            string sql = @"select {0} a.id as id,a.projectid as projectid,a.reporterid as reporterid,a.relationdate as relationdate,a.relationuserid as relationuserid,a.privateinfoid as privateinfoid,a.remark as remark,a.del as del,a.paytype as paytype,a.bankname as bankname,a.bankcardcode as bankcardcode,a.bankcardname as bankcardname,a.bankacountname as bankacountname,a.writingfee as writingfee,a.referral as referral,a.haveinvoice as haveinvoice,a.paystatus as paystatus,a.uploadstarttime as uploadstarttime,a.uploadendtime as uploadendtime,a.paymentmode as paymentmode,a.privateremark as privateremark,a.cooperatecircs as cooperatecircs,a.financecode as financecode {1} from media_projectreporterrelation as a {2} where 1=1 {3} ";
        ...
        public static DataTable QueryInfoByObj(ProjectreporterrelationInfo obj, string terms, Hashtable ht)
        {
            if (ht == null)
            {
                ht = new Hashtable();
        ...
        public static DataTable QueryInfoByObj(ProjectreporterrelationInfo obj, string terms, params SqlParameter[] param)
        {
            if (terms == null)
            {
                terms = string.Empty;
        ...
        #endregion
        #region load
        public static ProjectreporterrelationInfo Load(int id)
        {
            DataTable dt = null;
        ...
        public static ProjectreporterrelationInfo Load(int id, SqlTransaction trans)
        {
            DataTable dt = null;
        ...
        public static ProjectreporterrelationInfo setObject(DataRow dr)
        {
            ProjectreporterrelationInfo obj = new ProjectreporterrelationInfo();
            if (dr.Table.Columns.Contains("id") && dr["id"] != DBNull.Value)//id
            {
                obj.Id = Convert.ToInt32(dr["id"]);
            }
            if (dr.Table.Columns.Contains("projectid") && dr["projectid"] != DBNull.Value)//项目编号
            {
            ...
            if (dr.Table.Columns.Contains("privateinfoid") && dr["privateinfoid"] != DBNull.Value)//私密信息id
            {
                obj.Privateinfoid = Convert.ToInt32(dr["privateinfoid"]);
            }
            ...
            if (dr.Table.Columns.Contains("bankcardcode") && dr["bankcardcode"] != DBNull.Value)//银行卡号(帐号)
            {
                obj.Bankcardcode = (dr["bankcardcode"]).ToString();
            }
            if (dr.Table.Columns.Contains("bankcardname") && dr["bankcardname"] != DBNull.Value)//银行卡名
            {
                obj.Bankcardname = (dr["bankcardname"]).ToString();
            }
            if (dr.Table.Columns.Contains("bankacountname") && dr["bankacountname"] != DBNull.Value)//帐户名称
            {
